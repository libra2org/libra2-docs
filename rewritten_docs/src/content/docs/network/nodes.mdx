...
The Libra2 network consists of three node types: validator nodes, validator fullnodes (VFNs), and public fullnodes (PFNs). To
...
e.g., indexing, querying, and RESTful API services (see [Libra2 APIs](/build/apis)). VFNs can only be run by validator operators,
...
This section provides detailed, step-by-step instructions on how to deploy and operate Libra2 nodes in different
environments. It also describes everything you need to stake and participate in consensus and governance.

## Quick Links

### Validation on Libra2

Everything you need to know about how validation, staking and governance works on Libra2.

<CardGrid>
  <LinkCard href="/network/blockchain/staking#validation-on-the-libra2-blockchain" title="How validation works" description="Validator-leader proposes and earns rewards on success." />
...
<CardGrid>
  <LinkCard href="/network/blockchain/staking" title="Staking on Libra2" description="A comprehensive guide to how staking works on Libra2." />
...
<CardGrid>
  ...
  <LinkCard href="/network/nodes/validator-node/connect-nodes/connect-to-libra2-network" title="Connecting to Libra2 network" description="Steps to connect your nodes to an Libra2 network." />
...
A section with detailed, step-by-step instructions on everything related to Libra2 PFNs.

<CardGrid>
  <LinkCard href="/network/nodes/full-node/deployments" title="Deploy a PFN" description="Follow this section to deploy a PFN." />

  <LinkCard href="/build/indexer/legacy/indexer-fullnode" title="Indexer PFN" description="Describes how to run an indexer PFN on the Libra2 network." />
</CardGrid>
...
<CardGrid>
  ...
  <LinkCard href="/network/nodes/bootstrap-fullnode/libra2-db-restore" title="Bootstrap from a backup" description="Use data restore to bootstrap a new node." />
</CardGrid>
