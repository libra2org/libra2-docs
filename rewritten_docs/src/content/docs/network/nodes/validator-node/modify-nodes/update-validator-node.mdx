...
common operation for maintaining your nodes. Libra2 Foundation frequently releases new versions of the
Libra2 node software, and you should keep your nodes up to date to ensure they are secure and reliable.
...
1. Update your DNS to swap the [network addresses](/network/nodes/validator-node/connect-nodes/connect-to-libra2-network#3-update-on-chain-network-addresses) between the validator and VFN.
