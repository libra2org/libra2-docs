...
Before you can run a validator and validator fullnode (VFN) in an Libra2 network, you will need to select a deployment
method for your nodes. The guides below provide step-by-step instructions for deploying a validator node and VFN
on various platforms, and across different Libra2 networks.

Once your nodes are deployed, you can connect them to an Libra2 network by initializing your staking pool and joining
