...
the [Libra2 Validator Leaderboard](https://explorer.libra2labs.com/validators/all?network=mainnet).
...
[Libra2 Validator Leaderboard](https://explorer.libra2labs.com/validators/all?network=mainnet) shows the rewards
