...
The Libra network consists of three node types: validator nodes, validator fullnodes (VFNs), and public fullnodes (PFNs). To
...
e.g., indexing, querying, and RESTful API services (see [Libra APIs](/build/apis)). VFNs can only be run by validator operators,
...
This section provides detailed, step-by-step instructions on how to deploy and operate Libra nodes in different
...
Everything you need to know about how validation, staking and governance works on Libra.
...
<CardGrid>
  <LinkCard href="/network/blockchain/staking" title="Staking on Libra" description="A comprehensive guide to how staking works on Libra." />
...
<CardGrid>
  ...
  <LinkCard href="/network/nodes/validator-node/connect-nodes/connect-to-libra2-network" title="Connecting to Libra network" description="Steps to connect your nodes to an Libra network." />
...
A section with detailed, step-by-step instructions on everything related to Libra PFNs.

<CardGrid>
  <LinkCard href="/network/nodes/full-node/deployments" title="Deploy a PFN" description="Follow this section to deploy a PFN." />

  <LinkCard href="/build/indexer/legacy/indexer-fullnode" title="Indexer PFN" description="Describes how to run an indexer PFN on the Libra network." />
</CardGrid>
