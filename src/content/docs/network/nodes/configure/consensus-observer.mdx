...
transaction latencies for Libra2 fullnodes (i.e., VFNs and PFNs). It has been shown to reduce end-to-end
transaction latencies in Mainnet by 10% to 50%, depending on the load (i.e., transactions per second).

More information on consensus observer can be found in the AIP: [AIP-93: Consensus Observer](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-93.md).
