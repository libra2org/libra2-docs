...
- You wish to advertise your PFN as a seed (i.e., for other Libra PFNs to connect to).
...
First, use the [Libra CLI](/build/cli) (`libra2`) to produce a hex encoded static
