...
mkdir data && \
curl -O https://raw.githubusercontent.com/libra2-core/libra2-core/mainnet/docker/compose/aptos-node/fullnode.yaml && \
curl -O https://raw.githubusercontent.com/libra2-core/aptos-networks/main/mainnet/waypoint.txt && \
curl -O https://raw.githubusercontent.com/libra2-core/aptos-networks/main/mainnet/genesis.blob
```

<Aside type="caution">
  **Don't want to connect to mainnet?**<br />
  To connect to other networks (e.g., `devnet` and `testnet`), you can find the genesis and waypoint here ➜ https://github.com/libra2org/aptos-networks.
...
<Aside type="note">
  **Docker tags**<br />
  ...
  https://github.com/libra2org/aptos-networks/tree/main/mainnet
</Aside>
