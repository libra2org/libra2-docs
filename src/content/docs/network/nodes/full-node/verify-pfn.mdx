...
<Aside type="note">
  You can learn more about Libra metrics in the [Node Inspection Service](/network/nodes/measure/node-inspection-service) documents.
</Aside>
...
[Libra explorer page](https://explorer.libra2labs.com/?network=mainnet). If your node is catching up to the highest
...
If the number of outbound connections returned is `0`, then it means your node cannot connect to the Libra blockchain. If this happens to you, follow these steps to resolve the issue:
