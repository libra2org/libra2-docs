...
4. Modify the `main.tf` file to configure Terraform and create the Terraform module. See the example below:
   ...
   module "aptos-node" {
     ...
     source        = "github.com/libra2org/libra2-core.git//terraform/aptos-node/azure"
   ...
   - The Terraform variables [https://github.com/libra2org/libra2-core/blob/main/terraform/aptos-node/azure/variables.tf](https://github.com/libra2org/libra2-core/blob/main/terraform/aptos-node/azure/variables.tf)
