...
4. Modify the `main.tf` file to configure Terraform and create the Terraform module. See the example below:
   ...
   - The Terraform variables: [https://github.com/libra2org/libra2-core/blob/main/terraform/aptos-node/gcp/variables.tf](https://github.com/libra2org/libra2-core/blob/main/terraform/aptos-node/gcp/variables.tf)
