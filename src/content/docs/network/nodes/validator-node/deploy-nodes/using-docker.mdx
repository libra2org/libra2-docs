...
This is a step-by-step guide to deploy an Libra2 validator and validator fullnode (VFN) using Docker. Using this guide, the validator
...
<Aside type="caution">
  **Prerequisites** <br />
  ...
  installed the [Libra2 CLI](/build/cli), and [Docker with Docker Compose](https://docs.docker.com/engine/install/).
</Aside>
