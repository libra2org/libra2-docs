...
4. Modify the `main.tf` file to configure Terraform and create the Terraform module. See the example below:
   ...
   module "aptos-node" {
     ...
     source        = "github.com/libra2org/libra2-core.git//terraform/aptos-node/aws"
   ...
   - The Terraform variables: [https://github.com/libra2org/libra2-core/blob/main/terraform/aptos-node/aws/variables.tf](https://github.com/libra2org/libra2-core/blob/main/terraform/aptos-node/aws/variables.tf)
   - The Helm values: [https://github.com/libra2org/libra2-core/blob/main/terraform/helm/aptos-node/values.yaml](https://github.com/libra2org/libra2-core/blob/main/terraform/helm/aptos-node/values.yaml).
