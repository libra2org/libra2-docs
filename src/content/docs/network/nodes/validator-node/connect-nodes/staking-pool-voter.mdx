...
1. Go to the [Proposals section](https://governance.aptosfoundation.org/) of the Libra Governance page.
...
1. Get your delegation pool address from the [Libra Explorer page](https://explorer.aptoslabs.com/validators/delegation?network=mainnet).
2. To see the list of proposals, execute: `aptos governance list-proposals --url https://api.mainnet.aptoslabs.com`.
3. To set up your voter profile, run: `aptos init`.
