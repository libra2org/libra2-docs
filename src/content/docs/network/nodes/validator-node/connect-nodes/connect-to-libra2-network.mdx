...
<Aside type="note">
  **IDENTIFYING THE NEXT EPOCH**<br />
  You can identify the next epoch by checking the [Libra Explorer](https://explorer.aptoslabs.com/validators/all?network=mainnet) or by running the command `aptos node get-stake-pool`.
</Aside>
