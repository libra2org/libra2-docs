...
The Libra2 Labs team can also monitor your node remotely using [Node Telemetry](/network/nodes/configure/telemetry). When you enable telemetry on
...
internet, then it will report various key metrics to Libra2 Labs. Libra2 Labs will also observe the on-chain events
