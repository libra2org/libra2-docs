...
the [Libra Validator Leaderboard](https://explorer.libra2labs.com/validators/all?network=mainnet).
...
[Libra Validator Leaderboard](https://explorer.libra2labs.com/validators/all?network=mainnet) shows the rewards
