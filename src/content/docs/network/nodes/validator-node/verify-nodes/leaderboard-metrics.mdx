...
the [Libra Validator Leaderboard](https://explorer.aptoslabs.com/validators/all?network=mainnet).
...
[Libra Validator Leaderboard](https://explorer.aptoslabs.com/validators/all?network=mainnet) shows the rewards
