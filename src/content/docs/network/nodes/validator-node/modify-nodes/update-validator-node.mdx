...
common operation for maintaining your nodes. Libra Labs frequently releases new versions of the
Libra node software, and you should keep your nodes up to date to ensure they are secure and reliable.
