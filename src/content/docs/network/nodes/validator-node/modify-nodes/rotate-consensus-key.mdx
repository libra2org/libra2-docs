...
Using the following [Libra CLI](/build/cli) command to generate a new consensus identity.
...
Libra CLI is needed again, and your operator account is assumed to have been set up as a CLI profile `profile1`.
