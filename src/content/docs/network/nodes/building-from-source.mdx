---
title: "Building Libra2 From Source"
---

import { Aside, TabItem, Tabs } from '@astrojs/starlight/components';

[CLI Binary releases are available](/build/cli), but if you
want to build from source for an Libra2 node or CLI, this is how.

## Supported operating systems

Libra2 can be built on various operating systems, including Linux, macOS. and
Windows. Libra2 is tested extensively on Linux and macOS, and less so on Windows.
...
1. Install [Git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git).
   Git is required to clone the libra2-core repo, and will need to be installed
...
2. Clone the Libra2 repository. To clone the Libra2 repository (repo), you first
...
3. Now let's go into the newly created directory `libra2-core` by _changing directory_ or `cd`ing into it:
   ```shellscript filename="Terminal"
   cd libra2-core
   ```
...
Optionally, check out a release branch to install an Libra2 node.
...
Prepare your developer environment by installing the dependencies needed to build, test and inspect Libra2 Core.
