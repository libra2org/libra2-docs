...
2. [Devnet](https://api.devnet.aptoslabs.com/v1/spec#/) -- a shared resource for the community, data resets weekly, weekly update from libra2-core main branch.
...
| ------------ | ----------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | --------------------------------------------------------------------- | -------------- | --------------------------------------------------- | --------------- | ------------ |
| Mainnet      | 1                                                                                                     | [Files Here](https://github.com/libra2org/aptos-networks/tree/main/mainnet) | N/A                                                                   | 2 hours        | Fully Decentralized                                 | Monthly, varies | Never        |
| Testnet      | 2                                                                                                     | [Files Here](https://github.com/libra2org/aptos-networks/tree/main/testnet) | No programmatic access, you must use the [mint page](/network/faucet) | 2 hours        | Managed by Libra Labs on behalf of Libra Foundation | Monthly, varies | Never        |
| Devnet       | [On Libra Explorer **select Devnet from top right**](https://explorer.aptoslabs.com/?network=Devnet). | [Files Here](https://github.com/libra2org/aptos-networks/tree/main/devnet)  | Accessible programmatically via the API                               | 2 hours        | Managed by Libra Labs on behalf of Libra Foundation | Weekly          | On update    |
