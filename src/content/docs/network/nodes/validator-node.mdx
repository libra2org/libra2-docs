...
To participate in the Libra consensus protocol, you must deploy and run a validator node and (optionally) a validator
...
Use the documents within this section to run an Libra validator and a VFN. At a high-level, the process is as follows:
