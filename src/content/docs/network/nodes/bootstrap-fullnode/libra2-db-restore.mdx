...
| ------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| Testnet | Discontinued                                                                          | https://github.com/libra2org/aptos-networks/blob/main/testnet/backups/gcs.yaml |
| Mainnet | https://github.com/libra2org/aptos-networks/blob/main/mainnet/backups/s3-public.yaml | https://github.com/libra2org/aptos-networks/blob/main/mainnet/backups/gcs.yaml |
