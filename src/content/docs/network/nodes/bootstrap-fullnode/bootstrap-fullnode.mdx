...
This document describes how to bootstrap an Libra2 node quickly using a snapshot. This can be done on all node types,
...
<Aside type="caution">
  **Mainnet snapshots**<br />
  ...
  are not verified by the Libra2 software. As a result, the snapshot may be invalid or contain incorrect data. To prevent
...
There are a number of snapshots that can be downloaded from different Libra2 community members. These include:

- BWareLabs (Testnet and Mainnet): [BWareLabs Libra2 Node Snapshots](https://bwarelabs.com/snapshots/libra2)
...
<Aside type="note">
  **Questions about snapshot data** <br />
  ...
  questions about the snapshot data, or run into any issues, please reach out to the Libra2 community members directly
  via the [#node-support](https://discord.com/channels/945856774056083548/953421979136962560) channel in [Libra2 Discord](https://discord.gg/libra2network).
</Aside>
