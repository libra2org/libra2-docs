...
- BWareLabs (Testnet and Mainnet): [BWareLabs Libra Node Snapshots](https://bwarelabs.com/snapshots/aptos)
...
<Aside type="note">
  **Questions about snapshot data** <br />
  ...
  via the [#node-support](https://discord.com/channels/945856774056083548/953421979136962560) channel in [Libra Discord](https://discord.gg/aptosnetwork).
</Aside>
