...
the [official Libra website](https://aptosfoundation.org).
...
- This service also allows users to register subdomain names in addition to the
  ...
  at: [Libranames.com](https://www.aptosnames.com/)
...
- The **[Libra Explorer](https://explorer.aptoslabs.com/)** is an interface that
...
- For the legacy Libra Token Standard (aptos\_token::token), a **fungible token**
...
- For the Libra Digital Asset Standard (aptos\_token\_objects::token), a \*
...
- Move is a safe and secure programming language for web3 that emphasizes access
  ...
  in [Move on Libra](/network/blockchain/move). { /* TODO add move-on-aptos landing page */}
...
- A [**table**](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/doc/table.md)
  implements the Table type and in Libra is used to store information as
  key-value data within an account at large scale.

See [`table.move`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/table.move)
