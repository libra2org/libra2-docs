...
<CardGrid>
  <LinkCard href="https://libra2foundation.org/whitepaper/libra2-whitepaper_en.pdf" title="🇺🇸 English (en-US) ↗" description="Original Libra White Paper PDF in English" target="_blank" />

  <LinkCard href="https://libra2foundation.org/whitepaper/libra2-whitepaper_ko.pdf" title="🇰🇷 한국어 Korean (ko-KR) ↗" description="Libra White Paper PDF translated to Korean" target="_blank" />

  <LinkCard href="https://libra2foundation.org/whitepaper/libra2-whitepaper_ja.pdf" title="🇯🇵 日本語 Japanese (ja-JP) ↗" description="Libra White Paper PDF translated to Japanese" target="_blank" />

  <LinkCard href="https://libra2foundation.org/whitepaper/libra2-whitepaper_es.pdf" title="🇪🇸 Español Spanish (es-ES) ↗" description="Libra White Paper PDF translated to Spanish" target="_blank" />
</CardGrid>
