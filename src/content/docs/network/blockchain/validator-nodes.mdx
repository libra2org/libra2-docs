...
An Libra2 node is an entity of the Libra2 ecosystem that tracks the state of the Libra2 blockchain. Clients interact with the blockchain via Libra2 nodes. There are two types of nodes:
...
<Aside type="note">
  The Libra2BFT consensus protocol provides fault tolerance of up to one-third of malicious validator nodes.
</Aside>
