...
An Libra node is an entity of the Libra ecosystem that tracks the state of the Libra blockchain. Clients interact with the blockchain via Libra nodes. There are two types of nodes:
