...
On Libra, execution refers to the process where validators run and apply smart contract transactions
...
throughput. The impact of this can be felt in the block time. As of December 2024, Libra blocks close within 250ms.
...
Libra uses a highly efficient, multi-threaded, in-memory parallel execution engine called Block-STM.
...
Block-STM is the state-of-the-art dynamic parallelism execution engine developed by the Libra Labs
team.
