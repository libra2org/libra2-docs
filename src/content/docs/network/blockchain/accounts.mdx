...
Each account on the Libra blockchain is identified by a 32-byte account address. You can employ the Libra Name Service at [www.aptosnames.com](https://www.aptosnames.com/) to secure .apt domains for key accounts to make them memorable and unique.
