...
For the full delegation pool smart contract, see [delegation\_pool.move](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/delegation_pool.move)
...
[How Validation on the Libra blockchain works](/network/blockchain/staking#validation-on-the-aptos-blockchain)
