...
<CardGrid>
  ...
  <LinkCard href="/build/cli/install-cli/install-cli-windows" title="Windows" description="Install Aptos CLI on Windows via python script or pre-compiled binary" />

  <LinkCard href="/build/cli/install-cli/install-cli-linux" title="Linux" description="Install Aptos CLI on Linux via python script or pre-compiled binary" />
