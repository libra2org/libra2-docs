---
title: "Libra Improvement Proposals (AIPs)"
---

Libra Improvement Proposals (AIPs) are a way for the Libra community to propose
changes, improvements, and new features to the Libra protocol. AIPs are designed
...
and are administered by the Libra Foundation. Each AIP is assigned a unique
...
- Governance changes - Changes to the way the Libra Foundation operates, changes
