...
You can replay past transactions locally using the `libra2 move replay` command.
...
Let's use mainnet transaction [581400718](https://explorer.libra2labs.com/txn/581400718?network=mainnet) (a simple coin transfer transaction) as an example.

```shellscript filename="Terminal"
libra2 move replay --network mainnet --txn-id 581400718
```
...
```shellscript filename="Terminal"
libra2 move replay --network mainnet --txn-id 581400718 --benchmark
```
...
```shellscript filename="Terminal"
libra2 move replay --network mainnet --txn-id 581400718 --profile-gas
```
...
<details>
  ...
  Gas report saved to gas-profiling/txn-1ba73d03-0x1-libra2_account-transfer.
  {
    "Result": {
      "transaction_hash": "0x1ba73d03a0442a845735a17c7be46f3b51e2acb0e5cf68749305c5a17539ac63",
      "gas_used": 7,
...
<FileTree>
  - gas-profiling/
    - txn-1ba73d03-0x1-libra2\_account-transfer/
      - assets/
      - index.html
</FileTree>
