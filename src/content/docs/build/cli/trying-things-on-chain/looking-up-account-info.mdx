---
title: "Look Up On-Chain Account Info Using Libra2 CLI"
---
...
libra2 account list --account <your-profile-name-or-account-address>
```

This will show all resources that an account has. For example, below shows the balance as `coin:value`, and the associated coin for the native gas token APT would be `0x1::libra2_coin::Libra2Coin`.
...
```shellscript filename="Terminal"
libra2 account list --query modules
```
