...
`movefmt` is a formatter tool that makes Move code much easier to write, read, and maintain — greatly improving the development experience on Libra.

## Installation

`movefmt` is integrated into the Libra CLI. To begin using it, first install it using the CLI update command.
...
Libra Labs remains committed to improving the developer experience for builders using Move on Libra.
