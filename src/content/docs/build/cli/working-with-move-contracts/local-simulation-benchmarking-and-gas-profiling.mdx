...
The Libra Gas Profiler is a powerful tool that can help you understand the gas usage of Libra transactions. Once activated, it will simulate transactions using an instrumented VM, and generate a web-based report.
