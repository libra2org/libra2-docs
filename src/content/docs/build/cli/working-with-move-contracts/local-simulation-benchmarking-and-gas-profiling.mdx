...
For demonstration purposes, we will continue to use the [`hello_blockchain`](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/hello_blockchain) package as an example.
