...
This section references the [`CliArgs` example package](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/cli_args), which contains the following manifest:
...
[dependencies]
LibraFramework = { git = "https://github.com/libra2org/aptos-framework.git", rev = "mainnet", subdir = "aptos-framework" }
```

Here, the package is deployed under the named address `test_account`.

<Aside type="note" emoji="ℹ️">
  Set your working directory to [`aptos-move/move-examples/cli_args`](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/cli_args) to follow along:

  ```shellscript filename="Terminal"
  cd <libra2-core-parent-directory>/libra2-core/aptos-move/move-examples/cli_args
  ```
</Aside>
