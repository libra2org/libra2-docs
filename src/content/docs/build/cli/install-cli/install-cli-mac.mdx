---
title: "Install the Libra2 CLI on Mac"
---

import { Aside, Steps } from '@astrojs/starlight/components';

For Mac, the easiest way to install the Libra2 CLI is with the package manager `brew`.
...
<Steps>
  ...
  3. Open another terminal and run libra2 help to verify the CLI is installed.
...
<Steps>
  ...
  3. Download the zip file for macOS.
     ...
     1. It’ll have a name like: `libra2-cli-<version>-macOS-x86_64.zip` or `libra2-cli-<version>-macOS-arm64.zip`.
