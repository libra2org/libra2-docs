---
title: "Install the Libra CLI on Linux"
---

import { Aside, Steps } from '@astrojs/starlight/components';

For Linux, the easiest way to install the Libra CLI tool is via shell script, although if that does not work, you can also install manually via downloading pre-compiled binaries. The pre-compiled binaries approach is not generally recommended as updating is very manual.
...
<Aside type="note" emoji="ℹ️">
  If you would like to update the Libra CLI to the latest version, you can run `libra2 update`.
</Aside>
