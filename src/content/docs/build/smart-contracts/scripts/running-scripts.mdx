...
Move scripts are supported in the Libra2 TypeScript SDK, Libra2 Wallet Adapter,
and in the Libra2 CLI.
...
import { Libra2, Account, AccountAddress } from "@libra2-core/ts-sdk";
...
## Running scripts with the Libra2 Wallet Adapter
