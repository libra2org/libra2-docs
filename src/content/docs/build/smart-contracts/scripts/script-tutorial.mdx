...
The following example calls functions on the [aptos\_coin.move](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/aptos_coin.move) module to confirm the balance of the destination account is less than `desired_balance`, and if so, tops it up to `desired_balance`.
...
script {
    ...
    fun main(src: &signer, dest: address, desired_balance: u64) {
        ...
        let balance = coin::balance<aptos_coin::LibraCoin>(src_addr);
...
See also how to do this with the [Rust SDK](https://github.com/libra2org/aptos-developer-discussions/discussions/24) instead of the Libra CLI in Libra Developer Discussions.
