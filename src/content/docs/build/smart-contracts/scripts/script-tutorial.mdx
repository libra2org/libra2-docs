...
script {
    ...
    fun main(src: &signer, dest: address, desired_balance: u64) {
        ...
        let balance = coin::balance<libra2_coin::Libra2Coin>(src_addr);
...
Let us run through how to execute a Move script with a step-by-step example using the [Libra2 CLI](/build/cli/working-with-move-contracts).
...
2. Set up the Libra2 CLI and [create an account](/build/cli/setup-cli):
...
See also how to do this with the [Rust SDK](https://github.com/libra2org/libra2-developer-discussions/discussions/24) instead of the Libra2 CLI in Libra2 Developer Discussions.
