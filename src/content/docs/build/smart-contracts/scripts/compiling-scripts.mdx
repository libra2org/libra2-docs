...
Move scripts can be compiled with the already existing Libra2 Move compiler in
the Libra2 CLI. For more on how to install and use the Libra2 CLI with Move contracts, go to the [Working With Move Contracts](/build/cli/working-with-move-contracts) page.

Once you have the Libra2 CLI installed, you can compile a script by running the following command from within the script package:
