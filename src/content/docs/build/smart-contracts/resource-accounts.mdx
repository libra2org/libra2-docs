...
[Object Code Deployment](/build/smart-contracts/deployment) is the preferred method for deploying and upgrading smart contracts in Libra. Resource accounts require developers to generate seeds
...
In Libra, a resource account is created based upon the SHA3-256 hash of the
...
the creation of a resource account. But if a resource account is found, Libra
...
1. Using Libra CLI: `libra2 account create-resource-account` creates a resource
