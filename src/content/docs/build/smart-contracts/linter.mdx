...
The "Libra2 Move Lint" tool runs on a Move package to find and warn about common issues in Move programs, helping improve your Move code.

You can run it with the libra2 CLI command: `libra2 move lint`.

If you find any issues, please submit [bugs and feedback](https://github.com/libra2org/libra2-core/issues/new?title=%5Blinter%5D%20%3CDescriptive%20Title%3E\&body=%3CDetailed%20description%20of%20the%20issue%20or%20feature%20request%3E\&labels=move-linter\&projects=libra2-core/16). Also, we are tracking ideas and prioritization requests for new lint rules [here](https://github.com/libra2org/libra2-core/issues/15221), we welcome your contributions.
