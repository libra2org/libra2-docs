...
## Debugging with the Libra2 CLI

### Simulation on transaction submission

You can use the Libra2 CLI to simulate entry functions prior to executing them.
...
```shellscript name="Terminal"
 libra2 move run-script --script-path <script_path> ...
```
...
Gas report saved to gas-profiling/txn-a90ca655-0x1-libra2_account-transferred.
{
  "Result": {
