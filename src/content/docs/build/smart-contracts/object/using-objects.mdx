...
module my_addr::object_playground {
  use libra2_framework::object::{Object, ObjectCore};
...
```move filename="Example.move"
module my_addr::object_playground {
  use libra2_framework::object::{Self, Object, ObjectCore};
...
- [Digital Assets Examples](https://github.com/libra2org/libra2-core/tree/main/libra2-move/move-examples/token_objects)
- [Fungible Asset Examples](https://github.com/libra2org/libra2-core/tree/main/libra2-move/move-examples/fungible_asset)
