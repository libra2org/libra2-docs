...
You can find documentation for all possible `Refs` by looking at the Move reference docs for `0x1::object` [here](/move-reference/mainnet/libra2-framework/object).
