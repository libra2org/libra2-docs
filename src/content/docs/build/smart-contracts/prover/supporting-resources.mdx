...
- [Verify Smart Contracts in Libra with the Move Prover by MoveBit](https://www.movebit.xyz/blog/post/move-prover-tutorial-part-1.html)
...
- Park, Junkil, Teng Zhang, Wolfgang Grieskamp, Meng Xu, Gerardo Di Giacomo, Kundu Chen, Yi Lu, and Robert Chen. "Securing Libra framework with formal verification." In _5th International Workshop on Formal Methods for Blockchains (FMBC 2024)_. Schloss Dagstuhl–Leibniz-Zentrum für Informatik, 2024.
