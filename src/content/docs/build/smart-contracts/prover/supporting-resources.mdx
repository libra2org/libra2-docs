...
## Standard Libra2ry and Framework Specifications
...
- [`hello_prover` example](https://github.com/libra2org/libra2-core/tree/main/libra2-move/move-examples/hello_prover)
...
- [The Move Tutorial, steps 7 and 8](https://github.com/libra2org/libra2-core/tree/main/libra2-move/move-examples/move-tutorial#step-7--use-the-move-prover)
- [Verify Smart Contracts in Libra2 with the Move Prover by MoveBit](https://www.movebit.xyz/blog/post/move-prover-tutorial-part-1.html)
...
- [Formal verification of Move programs for the Libra2 blockchain by David Dill (video)](https://www.fields.utoronto.ca/talks/Formal-verification-Move-programs-Libra2-blockchain)
...
- Park, Junkil, Teng Zhang, Wolfgang Grieskamp, Meng Xu, Gerardo Di Giacomo, Kundu Chen, Yi Lu, and Robert Chen. "Securing Libra2 framework with formal verification." In _5th International Workshop on Formal Methods for Blockchains (FMBC 2024)_. Schloss Dagstuhl–Leibniz-Zentrum für Informatik, 2024.
