...
- [`hello_prover` example](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/hello_prover)
...
- [The Move Tutorial, steps 7 and 8](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/move-tutorial#step-7--use-the-move-prover)
