...
For examples of specifications, we refer to the [Libra framework](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/doc/overview.md)
...
- [APTOS\_FRAMEWORK](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/doc/overview.md)
