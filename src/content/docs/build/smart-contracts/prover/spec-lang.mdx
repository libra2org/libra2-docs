...
For examples of specifications, we refer to the [Libra framework](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/doc/overview.md)
