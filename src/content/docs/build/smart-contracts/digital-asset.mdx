---
title: "Libra2 Digital Asset Standard"
---
...
The Digital Asset (DA) standard is a modern Non-Fungible Token (NFT) standard for Libra2. NFTs represent unique assets on-chain, and are stored in collections. These NFTs can be customized to later be transferred, soulbound, burned, mutated, or customized via your own smart contracts.

This standard replaces the legacy [Libra2 Token Standard](/build/smart-contracts/libra2-token). The most important improvements to note are:
