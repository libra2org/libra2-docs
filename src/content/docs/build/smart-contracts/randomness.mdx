...
The full API function list and documentation can be found [here](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/doc/randomness.md).
...
You can also find the partial implementation of the API functions and example unit tests [here](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/randomness.move).
