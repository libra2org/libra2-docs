...
Unfortunately, without an equivalent of `random.randint()` in Libra2 Move, building a dApp version of it was actually much harder.
...
### Achieve simplicity + security with Libra2 randomness API

Using Libra2 randomness API, the implementation will look like this:
...
- `let winner_idx = libra2_framework::randomness::u64_range(0, n);` is the randomness API call that returns an u64 integer in range `[0, n)` uniformly at random.
...
## How to use Libra2 randomness API

### Prerequisites

Ensure you have the latest [libra2-cli](/build/cli) installed.
...
The full API function list and documentation can be found [here](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/doc/randomness.md).
...
3. abort if the result is not in their favor.
   ...
   This is referred to as a [test-and-abort attack](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-41.md#test-and-abort-attacks).

The Libra2 Move compiler has been updated to prevent this attack for your contract safety:
a randomness-dependent public function is treated as a compile error.
If you have finished the steps in the ["build Libra2 CLI"](/build/cli) section,
then your Libra2 CLI are equipped with the updated compiler.
...
Formally, this is referred to as an [undergasing attack](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-41.md#undergasing-attacks),
...
[Aptogotchi Random Mint](https://github.com/libra2org/aptogotchi-random-mint/tree/main) is an official demo dApp built to demonstrate the use of randomness API.

The full API function list and documentation can be found [here](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/doc/randomness.md).

You can also find the partial implementation of the API functions and example unit tests [here](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/sources/randomness.move).

See [AIP-41](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-41.md) for the API design,
and [AIP-79](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-79.md) if you are interested in system-level/cryptography details.
