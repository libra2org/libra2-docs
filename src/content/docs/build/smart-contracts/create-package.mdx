...
<Aside type="note">
  We recommend installing the Libra2 CLI before beginning.
  If you haven't already installed the Libra2 CLI, see the [CLI section](/build/cli)
</Aside>
...
<Steps>
  1. libra2 move init
     ...
     libra2 move init --name <PROJECT_NAME>
     ```
  ...
  2. Update Move.toml
     ...
     4. `dependencies`: You will likely want to use `Libra2Framework` and other [Third Party Dependencies](/build/smart-contracts/third-party-dependencies)
