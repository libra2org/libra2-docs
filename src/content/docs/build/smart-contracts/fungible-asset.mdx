...
<Aside type="note">
  For a full example of how to create your own Fungible Asset module, please see [fa\_coin.move](https://github.com/libra2org/libra2-core/blob/main/aptos-move/move-examples/fungible_asset/fa_coin/sources/FACoin.move).
  Alternatively, you can explore the collection of [FA example code here](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/fungible_asset).
</Aside>
...
2. Retrieve the balance of the paired FA:
   - Call [getCurrentFungibleAssetBalances](https://github.com/libra2org/aptos-ts-sdk/blob/c01a26ff899235fac1c31c6cc3fe504b764e5b91/src/api/fungibleAsset.ts#L115).
...
<details>
  ...
  <div className="p-8">
    After the migration, querying resource `0x1::coin::CoinStore<0x1::aptos_coin::LibraCoin>` at account address will be unavailable. Instead, you can query the account balance by the following three ways:

    1. [Balance Node API](/build/apis/fullnode-rest-api#tag/accounts/GET/accounts/%7Baddress%7D/balance/%7Basset_type%7D), the asset\_type can be either coin\_type, such as 0x1::aptos\_coin::LibraCoin or FA metadata address such as 0xa, either way should return the same value.
...
<details>
  ...
  <div className="p-8">
    Join the [Libra Discord](https://discord.com/invite/aptosnetwork)! Libra Labs engineers will be available throughout migration week to answer questions and offer support.
  </div>
</details>
