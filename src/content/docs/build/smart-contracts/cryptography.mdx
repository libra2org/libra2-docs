...
Cryptography plays an integral role in ensuring the security, integrity, confidentiality, and immutability of data in blockchain systems. The Libra2 adapter for Move provides developers with an array of cryptographic primitives to cater to this need. This document delves into the cryptographic functionalities offered by Move on Libra2 and elucidates the principles that drive their design.

## Cryptographic primitives

Move, through the Libra2 adapter, encompasses several fundamental cryptographic tools:
...
Some of these functions can be used for interoperability with other chains (e.g., verifying Ethereum Merkle proofs via [`libra2_std::libra2_hash::keccak256`](https://github.com/libra2org/libra2-core/blob/137acee4c6dddb1c86398dce25b041d78a3028d3/libra2-move/framework/libra2-stdlib/sources/hash.move#L35)).
Others, have lower gas costs, such as [`libra2_std::libra2_hash::blake2b_256`](https://github.com/libra2org/libra2-core/blob/137acee4c6dddb1c86398dce25b041d78a3028d3/libra2-move/framework/libra2-stdlib/sources/hash.move#L69).
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ----------------- | --------------- | ------------ | ----------- | ------------- | ------------------- |
| [ECDSA](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/secp256k1.move)                          | secp256k1     | 64                | 64              | Yes          | GGM         | Wide adoption | Security proof      |
| [Ed25519](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/ed25519.move)                          | Edwards 25519 | 64                | 32              | No           | DLA, ROM    | Fast          | Subtleties          |
| [MultiEd25519](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/multi_ed25519.move)               | Edwards 25519 | $4 + t \cdot 64$  | $n \cdot 32$    | No           | DLA, ROM    | Easy-to-adopt | Large sig. size     |
| [MinPK BLS](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/bls12381.move)                       | BLS12-381     | 96                | 48              | No           | CDH, ROM    | Versatile     | Slower verification |
| [MinSig BLS](https://github.com/libra2org/libra2-core/blob/7d4fb98c6604c67e526a96f55668e7add7aaebf6/libra2-move/move-examples/drand/sources/drand.move#L57) | BLS12-381     | 48                | 96              | No           | CDH, ROM    | Versatile     | Slower verification |
...
Normally, developers of such applications would have to wait until their desired cryptographic functionality is implemented efficiently as a [Move native function](/build/smart-contracts/book/functions#native-functions) in the [Libra2 Move framework](/network/blockchain/move).
...
1. Ristretto255, via [`libra2_std::ristretto255`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/ristretto255.move)
2. BLS12-381, via [`libra2_std::crypto_algebra`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/crypto_algebra.move)
   and [`libra2_std::bls12381_algebra`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/bls12381_algebra.move)
...
The [`libra2_std::ristretto255`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/ristretto255.move) module provides support for elliptic curve arithmetic on the popular [Ristretto255 curve](https://ristretto.group/).
...
2. **ElGamal** encryption – See [`libra2_std::ristretto255_elgamal`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/ristretto255_elgamal.move)
3. **Pedersen** commitments – See [`libra2_std::ristretto255_pedersen`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/ristretto255_pedersen.move)
4. **Bulletproofs** ZK range proofs\[^bulletproofs] – See [`libra2_std::ristretto255_bulletproofs`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/ristretto255_bulletproofs.move)
...
The [`libra2_std::crypto_algebra`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/crypto_algebra.move) provides elliptic curve arithmetic operations for **any** supported elliptic curve, including pairing-friendly curves.
...
Although currently the `crypto_algebra` module only supports arithmetic over BLS12-381 curves (via the marker types declared in [`libra2_std::bls12381_algebra`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/cryptography/bls12381_algebra.move)), more curves will be supported into the future (e.g., BN254, Ristretto255, BLS12-377, BW6-761, secp256k1, secp256r1).
...
The [`veiled_coin` example](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-experimental/sources/veiled_coin/) demonstrates how to use [the Ristretto255 modules from above](#ristretto255-arithmetic) to add a reasonable layer of confidentiality to coin balances and transactions.
...
The [`groth16` example](https://github.com/libra2org/libra2-core/blob/main/libra2-move/move-examples/groth16_example/sources/groth16.move) demonstrates how to verify Groth16 zkSNARK proofs\[^groth16], which are the shortest, fastest-to-verify, general-purpose zero-knowledge proofs.
...
The [`drand` example](https://github.com/libra2org/libra2-core/tree/main/libra2-move/move-examples/drand/sources) shows how to verify public randomness from the [drand](https://drand.love) randomness beacon.
This randomness can be used in games or any other chance-based smart contract.
We give a simple example of a lottery implemented on top of `drand` randomness in [`lottery.move`](https://github.com/libra2org/libra2-core/tree/main/libra2-move/move-examples/drand/sources/lottery.move).
