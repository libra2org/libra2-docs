...
- Visit the [Libra Developer Portal](https://aptos.dev) and log in with your account.
...
8. You can now use Claude Code to interact with the Libra MCP. Prompt the agent with `what aptos mcp version are you using?` to verify the connection. The agent should reply with something like:
