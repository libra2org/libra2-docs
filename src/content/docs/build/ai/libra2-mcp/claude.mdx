---
title: "Libra2 MCP & Claude Code"
---

## Set up Claude Code with Libra2 MCP
...
- Visit the [Libra2 Developer Portal](https://docs.libra2.org) and log in with your account.
...
8. You can now use Claude Code to interact with the Libra2 MCP. Prompt the agent with `what libra2 mcp version are you using?` to verify the connection. The agent should reply with something like:

```text
I'm using Libra2 MCP version 0.0.2.
```
