---
title: "Libra2 MCP & Cursor"
---

# Set up Cursor with Libra2 MCP
...
6. Prompt the agent with `what libra2 mcp version are you using?` to verify the connection. The agent should reply with something like:
