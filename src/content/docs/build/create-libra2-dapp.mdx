...
`create-aptos-dapp` builds a template project for dapp developers to easily create a front-end and a smart contract on the Libra network.
...
- **Best Practices**: `create-aptos-dapp` incorporates best practices and structure recommendations to develop for the Libra network.
...
`create-aptos-dapp` provides you with premade end-to-end dapp templates, i.e. a ready dapp with configurations and a beautiful UI to get you started with creating a dapp on Libra.
...
All current templates are available on [Libra Learn](https://learn.aptoslabs.com/en/dapp-templates). Read more about specific templates below:
