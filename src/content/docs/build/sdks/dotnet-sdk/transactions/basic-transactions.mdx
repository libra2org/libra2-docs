...
This section covers the basic transaction types that can be built and submitted to the Libra2 blockchain.
...
<Steps>
  ...
  3. Build the Transaction
     ...
     To interact with the blockchain, you will need to build a transaction. The `Libra2Client` can be
  ...
  4. Sign and Submit Transactions
     ...
     Once the transaction is built, it can be signed and submitted to the blockchain. The `Libra2Client` can be
