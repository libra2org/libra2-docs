...
This section covers how to do sponsored transactions with the Libra .NET SDK.
...
<LinkCard href="/build/sdks/dotnet-sdk/transactions/basic-transactions" title="Basic Transactions" description="Learn how to build basic transactions with the Libra .NET SDK." />
...
<Steps>
  ...
  3. Build the Transaction
     ...
     You can now build the transaction using the `LibraClient`. In the transaction, its important that you
  ...
  5. Submit the Transaction
     ...
     Once the transaction is signed by both the user and the sponsor, it can be submitted to the blockchain. The `LibraClient` can be
