...
The Libra2 .NET SDK provides a simple way to create and manage Ed25519 accounts. In this guide we
...
The derivation path that is typically used throughout the Libra2 ecosystem is `m/44'/637'/0'/0'/0'`.
...
<CardGrid>
  <LinkCard href="https://libra2-core.github.io/libra2-dotnet-sdk/docs/Libra2.Ed25519Account.html" title="Ed25519Account Reference" description="The full API reference for the Ed25519Account class." target="_blank" />
</CardGrid>
