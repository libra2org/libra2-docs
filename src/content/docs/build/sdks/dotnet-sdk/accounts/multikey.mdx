...
The Libra2 .NET SDK provides an implementation of Multikey accounts to create accounts from a combination of multiple key pairs. This is useful for
...
<Steps>
  ...
  4. Sign and Submit transactions
     ...
     After creating a MultiKey account, you can sign and submit transactions using the `Libra2Client`.
...
<CardGrid>
  <LinkCard href="https://libra2-core.github.io/libra2-dotnet-sdk/docs/Libra2.MultiKeyAccount.html" title="MultiKeyAccount Reference" description="The full API reference for the MultiKeyAccount class." target="_blank" />
</CardGrid>
