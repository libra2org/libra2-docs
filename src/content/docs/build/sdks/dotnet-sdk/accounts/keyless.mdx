...
The Libra2 .NET SDK provides an implementation of Keyless accounts to derive accounts from social provider logins. In this guide,
...
<Steps>
  ...
  4. Sign and Submit transactions
     ...
     After deriving a Keyless account, you can sign and submit transactions using the `Libra2Client`.
...
<CardGrid>
  <LinkCard href="https://libra2-core.github.io/libra2-dotnet-sdk/docs/Libra2.KeylessAccount.html" title="KeylessAccount Reference" description="The full API reference for the KeylessAccount class." target="_blank" />
</CardGrid>
