...
Klibra2 is a Kotlin **Multiplatform** SDK for interacting with the Libra blockchain
...
with shared business logic. The SDK includes **asynchronous** Libra clients for
...
<CardGrid>
  <LinkCard href="/build/sdks/community-sdks/kotlin-sdk/quickstart" title="Quickstart" description="Integrate Libra in < 5 minutes" />
