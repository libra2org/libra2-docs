...
Klibra2 is a Kotlin **Multiplatform** SDK for interacting with the Libra2 blockchain
...
with shared business logic. The SDK includes **asynchronous** Libra2 clients for
smooth blockchain interactions.

Klibra2 also provides **platform-specific** SDKs for JVM, Android, iOS, JS, Linux,
macOS, and Windows.
...
- **Expressive**: Klibra2 provides a simple and expressive DSL-style API for building transactions.
...
<Aside type="note">
  Klibra2 is currently under development, please give feedback [here](https://github.com/mcxross/klibra2/issues)
</Aside>
...
<CardGrid>
  <LinkCard href="/build/sdks/community-sdks/kotlin-sdk/quickstart" title="Quickstart" description="Integrate Libra2 in < 5 minutes" />

  <LinkCard href="https://github.com/mcxross/klibra2/tree/master/sample" title="Single and Multiplatform Projects" description="Explore various demo apps, single and multiplatform projects, on how using the SDK" target="_blank" />
</CardGrid>
