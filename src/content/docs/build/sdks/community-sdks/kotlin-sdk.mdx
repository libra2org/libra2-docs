...
import { TabItem, Tabs, LinkCard, Aside, CardGrid, Card } from '@astrojs/starlight/components';
...
<CardGrid>
  <LinkCard href="./kotlin-sdk/quickstart" title="Quickstart" description={"Integrate Aptos in < 5 minutes"} />
  <LinkCard href="https://github.com/mcxross/kaptos/tree/master/sample" title="Single and Multiplatform Projects" description={"Explore various demo apps, single and multiplatform projects, on how using the SDK"} />
</CardGrid>
