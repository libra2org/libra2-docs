...
```kotlin
val signerAuthenticator = libra2.signAsFeePayer(
    feePayer = sponsor,
    transaction = txn,
)
```
...
```kotlin
val committedTxn = libra2.submitTransaction.simple(
      transaction = txn,
...
<Aside type="note" emoji="ℹ️">
  ...
  ```kotlin
    val committedTxn = libra2.signAndSubmitAsFeePayer(sponsor, aliceAuthenticator, txn)
  ```
</Aside>
