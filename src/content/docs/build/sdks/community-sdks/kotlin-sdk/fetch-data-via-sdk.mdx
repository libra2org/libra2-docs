...
You can use the Libra2 client to fetch all sorts of data from on-chain such as
...
`.view` method on the `Libra2` object.
...
val inputViewFunctionData = InputViewFunctionData(
      "0x1::coin::supply",
      listOf(TypeTagStruct("0x1::libra2_coin::Libra2Coin")),
      emptyList(),)
