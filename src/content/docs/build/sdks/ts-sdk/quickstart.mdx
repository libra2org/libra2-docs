...
3. Looking up data from on-chain using client helper functions like [`aptos.getAccountModules`](https://libra2-core.github.io/aptos-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra.html#getAccountModules).
...
<Aside type="note">
  For future development, make sure to bookmark the [reference docs](https://libra2-core.github.io/aptos-ts-sdk/) to look up specific function signatures.

  Note that most helper functions are listed on the [`Libra` client object](https://libra2-core.github.io/aptos-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra.html).
</Aside>
