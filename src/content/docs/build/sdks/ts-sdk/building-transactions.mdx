...
<Aside type="note">
  For these examples, `aptos` is an instance of the [`Libra`](https://libra2-core.github.io/aptos-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra.html) client object.
</Aside>
...
<Steps>
  ...
  5. Wait
     ...
     Finally, you can wait for the result of the transaction by using [`aptos.waitForTransaction`](https://libra2-core.github.io/aptos-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra.html#waitForTransaction) and specifying the hash of the transaction you just submitted like so:
