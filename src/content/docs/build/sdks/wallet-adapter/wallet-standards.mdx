...
- See the [Libra TypeScript SDK's implementation for the derive path](https://github.com/libra2org/aptos-ts-sdk/blob/main/src/account/Account.ts#L181-L202)
...
- See the [Libra TypeScript SDK's implementation for the derive path](https://github.com/libra2org/libra2-core/blob/1bc5fd1f5eeaebd2ef291ac741c0f5d6f75ddaef/ecosystem/typescript/sdk/src/aptos_account.ts#L49-L69)
