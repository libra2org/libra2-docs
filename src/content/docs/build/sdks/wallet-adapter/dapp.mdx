...
2. (Optional) Install the plugins for any “Legacy Standard Compatible” Wallets you want to support from .
...
5. Import useWallet in files where you want to access data from the Provider.
