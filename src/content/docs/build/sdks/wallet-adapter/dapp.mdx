...
<Steps>
  1. Install @libra2-core/wallet-adapter-react.
     ...
     <details>
       ...
       ### (Optional) Install the plugins for any “Legacy Standard Compatible” Wallets you want to support from [this list](https://github.com/libra2org/aptos-wallet-adapter/blob/main/README.md#supported-wallet-packages).
...
The [Wallet Adapter repository](https://github.com/libra2org/aptos-wallet-adapter) provides several UI packages to simplify allowing users to connect and select a wallet.
...
Otherwise, you should use the [shadcn/ui wallet selector](https://github.com/libra2org/aptos-wallet-adapter/blob/main/apps/nextjs-example/README.md#use-shadcnui-wallet-selector-for-your-own-app), as it has the most customization options. For more details on how to customize this wallet selector or build your own wallet selector, see [this guide](https://github.com/libra2org/aptos-wallet-adapter/blob/main/packages/wallet-adapter-react/docs/BYO-wallet-selector.md).

<Aside type="note">
  For an example that shows how these UI options work in practice, see the [live demo app](https://libra2-core.github.io/aptos-wallet-adapter/) (you can find its reference code [here](https://github.com/libra2org/aptos-wallet-adapter/tree/main/apps/nextjs-example)).
</Aside>
...
_See [`WalletCore.ts`](https://github.com/libra2org/aptos-wallet-adapter/blob/main/packages/wallet-adapter-core/src/WalletCore.ts) in [`wallet-adapter-core`](https://github.com/libra2org/aptos-wallet-adapter/tree/main/packages/wallet-adapter-core) for where these functions are implemented._
...
- [Live site](https://libra2-core.github.io/aptos-wallet-adapter/)
- [Source code](https://github.com/libra2org/aptos-wallet-adapter/tree/main/apps/nextjs-example)
