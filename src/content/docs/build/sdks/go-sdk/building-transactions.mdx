...
<Steps>
  1. Build
     ...
     2. `GasUnitPrice` - You can specify a higher than minimum price per gas to be
        executed with higher priority by the Libra network.
  ...
  2. Simulate (Optional)
     ...
     Every transaction on the Libra chain has a gas fee associated with how much
...
4. [Binary Canonical Serialization (BCS)](/build/sdks/go-sdk/building-transactions/bcs-format) - The format used to serialize data for Libra transactions.
