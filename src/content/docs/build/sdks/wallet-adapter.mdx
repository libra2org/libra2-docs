...
1. [Libra Wallet Adapter](#libra2-wallet-adapter) by Libra Labs
...
2. For [SDK Wallets](/build/sdks/wallet-adapter/wallets) (ex. [LibraConnect](https://libra2connect.app))
...
more information about OKX Connect for Libra dapps in the [OKX Connect documentation](https://web3.okx.com/build/dev-docs/sdks/app-connect-libra2)
