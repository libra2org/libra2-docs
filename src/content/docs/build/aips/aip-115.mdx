...
[AIP-115](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-115.md) covers
stateless accounts.
...
A Stateless Account is a new behavior for Libra2 accounts that allows them to
...
interact with the Libra2 blockchain.
