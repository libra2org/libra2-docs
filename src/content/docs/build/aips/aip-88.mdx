...
[AIP-88](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-88.md) covers
...
If you're using the Libra2 Go SDK or the Libra2 TypeScript SDK, you can update to
