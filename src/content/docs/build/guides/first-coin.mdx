...
[Install the precompiled binary for the Libra CLI](/build/cli).
...
These are read by the example and published to the Libra blockchain:
...
Once a coin type has been published to the Libra blockchain, the entity that published that coin type can initialize it:
...
Libra provides several building blocks to support coin transfers:
