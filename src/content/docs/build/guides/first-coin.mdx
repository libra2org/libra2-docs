...
This tutorial introduces how you can compile, deploy, and mint your own coin (as defined [here](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/coin.move)), named [MoonCoin](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/moon_coin).
...
<Tabs>
  <TabItem label="TypeScript">
    ...
    git clone https://github.com/libra2org/aptos-ts-sdk.git
    cd aptos-ts-sdk
    pnpm install
    pnpm build
    ```
    ...
    Run the TypeScript [`your_coin`](https://github.com/libra2org/aptos-ts-sdk/blob/main/examples/typescript/your_coin.ts) example:
  ...
  <TabItem label="Python">
    ...
    Run the Python [`your_coin`](https://github.com/libra2org/aptos-python-sdk/blob/main/examples/your_coin.py) example:

    ```shellscript filename="Terminal"
    poetry run python -m examples.your_coin ~/libra2-core/aptos-move/move-examples/moon_coin
    ```
    ...
    ```shellscript filename="Terminal"
    cd ~/libra2-core/aptos-move/move-examples/moon_coin
    ```
...
<Aside type="note">
  ...
  [`ManagedCoin`](https://github.com/libra2org/libra2-core/blob/f81ccb01f00227f9c0f36856fead4879f185a9f6/aptos-move/framework/aptos-framework/sources/managed_coin.move#L1) is a simple coin management framework for coins directly managed by users. It provides convenience wrappers around `mint` and `burn`.
</Aside>
