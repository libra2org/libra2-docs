...
Libra blockchain. Here are two examples:

- [MerkleTrade](https://merkle.trade/) offers low cost trading to those with
  Ethereum wallets by creating an Libra wallet for users and covering all
...
In Libra, a sponsored transaction reuses the same SignedTransaction as any other
user transaction:
