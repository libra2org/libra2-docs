...
As outlined
in [AIP-39](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-39.md),
...
Libra2 blockchain. Here are two examples:

- [MerkleTrade](https://merkle.trade/) offers low cost trading to those with
  Ethereum wallets by creating an Libra2 wallet for users and covering all
  transaction fees so that the user does not need to acquire utility tokens for
  Libra2.
- Community engagement applications
  like [Graffio](https://medium.com/libra2labs/graffio-web3s-overnight-sensation-81a6cf18b626)
...
In Libra2, a sponsored transaction reuses the same SignedTransaction as any other
user transaction:
...
- The TypeScript SDK
  has [several examples](https://github.com/libra2org/libra2-ts-sdk/tree/main/examples/typescript-esm/sponsored_transactions)
- The Python SDK has an example
  in [fee\_payer\_transfer\_coin.py](https://github.com/libra2org/libra2-python-sdk/blob/main/examples/fee_payer_transfer_coin.py).
- The Rust SDK has a test case
  in [the API tests](https://github.com/libra2org/libra2-core/blob/0a62e54e13bc5da604ceaf39efed5c012a292078/api/src/tests/transactions_test.rs#L255).
