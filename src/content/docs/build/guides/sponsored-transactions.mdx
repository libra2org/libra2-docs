...
- The TypeScript SDK
  has [several examples](https://github.com/libra2org/aptos-ts-sdk/tree/main/examples/typescript-esm/sponsored_transactions)
- The Python SDK has an example
  in [fee\_payer\_transfer\_coin.py](https://github.com/libra2org/aptos-python-sdk/blob/main/examples/fee_payer_transfer_coin.py).
