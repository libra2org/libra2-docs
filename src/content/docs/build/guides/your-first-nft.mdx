...
<Steps>
  1. Setup the Client
     ...
     This `aptos` object allows us to interact with the Libra blockchain (funding accounts, creating assets, submitting transactions, etc.).
...
<Steps>
  ...
  7. View Your Transactions on the Explorer
     ...
     2. Visit [Libra Explorer](https://explorer.aptoslabs.com/?network=devnet)
