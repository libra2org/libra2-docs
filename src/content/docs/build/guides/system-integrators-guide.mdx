...
accounts when transferring Libra coin via [`aptos_account::transfer`](https://github.com/libra2org/libra2-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/aptos-move/framework/aptos-framework/sources/aptos_account.move#L18)
or explicitly via [`aptos_account::create_account`](https://github.com/libra2org/libra2-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/aptos-move/framework/aptos-framework/sources/aptos_account.move#L13).

At creation, an [Libra account](https://github.com/libra2org/libra2-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/aptos-move/framework/aptos-framework/sources/account.move#L23) contains:

- A [resource containing Libra Coin](https://github.com/libra2org/libra2-core/blob/60751b5ed44984178c7163933da3d1b18ad80388/aptos-move/framework/aptos-framework/sources/coin.move#L50)
...
the `hash` [field](https://github.com/libra2org/libra2-core/blob/9b85d41ed8ef4a61a9cd64f9de511654fcc02024/ecosystem/python/sdk/aptos_sdk/client.py#L138).
...
example [Move script](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/scripts/two_by_two_transfer)
that uses a MultiAgent transaction to extract funds from two accounts and
deposit them into two other accounts. This is
a [Python example](https://github.com/libra2org/aptos-python-sdk/blob/main/examples/transfer_two_by_two.py)
...
Both
the [Typescript SDK](https://github.com/libra2org/aptos-ts-sdk/blob/main/src/api/transactionSubmission/simulate.ts)
and [Python SDK](https://github.com/libra2org/aptos-python-sdk/blob/main/examples/simulate_transfer_coin.py)
...
Libra has a
standard [Fungible Asset](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/fungible_asset.move).
...
the [`primary_fungible_store::transfer`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/primary_fungible_store.move#L142)
function.
...
[Coin type](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/coin.move).
...
creation, each user has the resource `CoinStore<0x1::aptos_coin::LibraCoin>`
...
the [`aptos_account::transfer_coins`](https://github.com/libra2org/libra2-core/blob/d1610e1bb5214689a37a9cab59cf9254e8eb2be1/aptos-move/framework/aptos-framework/sources/aptos_account.move#L92)
function for all coins
and [`aptos_account::transfer`](https://github.com/libra2org/libra2-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/aptos-move/framework/aptos-framework/sources/aptos_account.move#L18)
for Libra coins.
...
<Aside type="note">
  ...
  sufficient. `0x1::aptos_coin::LibraCoin`, however, requires
...
3. A gas fee `2200` of `0x1::aptos_coin::LibraCoin` from the sending account `0x810026ca8291dd88b5b30a1d3ca2edd683d33d06c4a7f7c451d96f6d47bc5e8b`
...
1. The `gas_used` field must be multiplied times the `gas_unit_price`. In this
   ...
   withdrawn is `2200`.
2. Gas is always: `0x1::aptos_coin::LibraCoin`
