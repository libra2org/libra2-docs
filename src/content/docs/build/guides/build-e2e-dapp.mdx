---
title: "Build an End-to-End Dapp on Libra2"
---
...
See the completed code in the [source-code](https://github.com/libra2org/developer-docs/tree/main/apps/nextra/pages/en/build/guides/build-e2e-dapp).
...
For that, we will be using [create-libra2-dapp](/build/create-libra2-dapp) to create the project.

1. Open a terminal and navigate to the desired directory for the project (for example, the `Desktop` directory).
2. Run `npx create-libra2-dapp@latest` to create the project.
