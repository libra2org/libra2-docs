...
In the third chapter of the tutorial on [building an end-to-end dapp on Libra](/build/guides/build-e2e-dapp), you will be learning to fetch data from chain.
...
To fetch data from chain, we can use the [Libra TypeScript SDK](/build/sdks/ts-sdk). The SDK provides classes and functions for us to easily interact and query the Libra chain.
