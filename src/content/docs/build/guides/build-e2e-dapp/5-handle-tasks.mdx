...
In the fifth and final chapter of the tutorial on [building an end-to-end dapp on Libra](/build/guides/build-e2e-dapp), you will add functionality to the app so the user interface is able to handle cases where an account has created a list.
...
You have now learned how to build a dapp on Libra from end to end. Congratulations! Tell your friends. :-)
