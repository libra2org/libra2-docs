...
This is the second chapter of the tutorial on [building an end-to-end dapp on Aptos](/build/guides/build-e2e-dapp) where you have already [created a smart contract](/build/guides/build-e2e-dapp/1-create-smart-contract) and are now setting up a React app.
...
2. Your file structure should look something like:
   ...
   ![client-folder](/images/build-e2e-dapp-img-2.png)
...
It is now time to [add wallet support](/build/guides/build-e2e-dapp/3-add-wallet-support) in chapter 3.
