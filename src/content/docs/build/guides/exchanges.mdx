...
- An earlier [Coin standard](/build/smart-contracts/aptos-coin) used by assets on Libra.
...
represented as a struct name e.g. `0x1::aptos_coin::LibraCoin` for `APT`.
...
<Aside type="note">
  APT, the native token of Libra, is a migrated coin.  Please use the `aptos_account::transfer` functions
...
- [`0x1::aptos_account::transfer_coins<CoinType>(receiver address, amount)`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/aptos_account.move#L108-L112) - Transfer a coin to another account.
- [`0x1::aptos_account::batch_transfer_coins<CoinType>(receiver addresses, amounts)`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/aptos_account.move#L93-L106) - Transfer a coin to multiple accounts.
- [`0x1::aptos_account::transfer(receiver address, amount)`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/aptos_account.move#L74-L91) - Transfer specifically APT to another account.
...
To test balance checks, you can check the balance for the account `0x5` for the asset `0x1::aptos_coin::LibraCoin`.
