...
<Steps>
  ...
  2. Step 2. Register the JSON Web Key Set (JWKS) on-chain
     ...
     To learn more about the `0x1::jwks::update_federated_jwk_set` entry function, see the [reference documentation](https://aptos.dev/en/move-reference?page=aptos-framework%2Fdoc%2Fjwks.md#0x1_jwks_update_federated_jwk_set).
