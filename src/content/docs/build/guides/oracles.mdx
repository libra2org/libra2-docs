---
title: "Use Oracles in Your Libra2 Applications"
---

import { Aside } from '@astrojs/starlight/components';

This reference guide presents various Oracles that you can utilize while building on Libra2. Oracles supply offchain data to the blockchain, enabling smart contracts to access a diverse range of information.
...
## How to Use Pyth Real-Time Data in Libra2 Contracts

This guide explains how to use real-time Pyth data in Libra2 applications.
...
The named addresses of `pyth`, `wormhole`, and `deployers` must be defined at compile time. These addresses are used to interact with the Pyth contract on Libra2.
...
Consult [Libra2 Contract Addresses](https://docs.pyth.network/price-feeds/contract-addresses/libra2) for the complete list of contract addresses on different Libra2 networks.
...
module example::example {
    ...
    public fun get_btc_usd_price(user: &signer, pyth_price_update: vector<vector<u8>>): Price {
        ...
        // Note: Libra2 uses the Pyth price feed ID without the `0x` prefix.
...
You may find these additional resources helpful for developing your Libra2 application.

## Sponsored Feeds on Libra2

The price feeds listed in the table below are currently sponsored in **Libra2 mainnet**.
...
The [Libra2 API reference](https://docs.pyth.network/price-feeds/api-reference/libra2) lets you interactively explore the complete API of the Pyth contract.

### Example Applications

- [Minimal on-chain contract](https://github.com/pyth-network/pyth-examples/blob/main/price_feeds/libra2/fetch_btc_price/sources/example.move), which updates and returns the BTC/USD price from Pyth price feeds.
- [Mint NFT](https://github.com/pyth-network/pyth-examples/tree/main/price_feeds/libra2/mint_nft) that use Pyth price feeds to mint an NFT.
