---
title: "Use Oracles in Your Libra Applications"
---

import { Aside } from '@astrojs/starlight/components';

This reference guide presents various Oracles that you can utilize while building on Libra. Oracles supply offchain data to the blockchain, enabling smart contracts to access a diverse range of information.
...
## How to Use Pyth Real-Time Data in Libra Contracts

This guide explains how to use real-time Pyth data in Libra applications.
...
The named addresses of `pyth`, `wormhole`, and `deployers` must be defined at compile time. These addresses are used to interact with the Pyth contract on Libra.
...
Consult [Libra Contract Addresses](https://docs.pyth.network/price-feeds/contract-addresses/libra2) for the complete list of contract addresses on different Libra networks.
...
module example::example {
    ...
    public fun get_btc_usd_price(user: &signer, pyth_price_update: vector<vector<u8>>): Price {
        ...
        // Note: Libra uses the Pyth price feed ID without the `0x` prefix.
...
You may find these additional resources helpful for developing your Libra application.

## Sponsored Feeds on Libra

The price feeds listed in the table below are currently sponsored in **Libra mainnet**.
...
The [Libra API reference](https://docs.pyth.network/price-feeds/api-reference/libra2) lets you interactively explore the complete API of the Pyth contract.
