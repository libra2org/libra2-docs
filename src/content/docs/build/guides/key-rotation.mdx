...
<Steps>
  ...
  3. Initialize a profile
     ...
     <details>
       ...
       ---
       Libra CLI is now set up for account 0xaaa5131b4d3fcef8d33ee465c4ee65727e36039f283455be87b1164200572e5b as profile test-profile-1!  Run `aptos --help` for more information about commands
       {
         "Result": "Success"
       }
       ```
  ...
  11. Attempt invalid rotation (new key already mapped)
      ...
      <details>
        ...
        ---
        Libra CLI is now set up for account 0xccc79d46b2963cb87f2ff32c51eb6c6361e8aa108d334d3183c3016389542958 as profile test-profile-3!  Run `aptos --help` for more information about commands
        {
          "Result": "Success"
        }
        ```
...
[here](https://github.com/libra2org/aptos-ts-sdk/blob/main/examples/typescript/rotate_key.ts).
...
View the full example for this code
[here](https://github.com/libra2org/aptos-python-sdk/blob/main/examples/rotate_key.py).
...
[`account::rotate_authentication_key`]: https://github.com/libra2org/libra2-core/blob/acb6c891cd42a63b3af96561a1aca164b800c7ee/aptos-move/framework/aptos-framework/sources/account.move#L326

[`account::rotate_authentication_key_call`]: https://github.com/libra2org/libra2-core/blob/acb6c891cd42a63b3af96561a1aca164b800c7ee/aptos-move/framework/aptos-framework/sources/account.move#L294

[`account::RotationProofChallenge`]: https://github.com/libra2org/libra2-core/blob/acb6c891cd42a63b3af96561a1aca164b800c7ee/aptos-move/framework/aptos-framework/sources/account.move#L79
...
[`account::set_originating_address`]: https://github.com/alnoki/libra2-core/blob/5ba4a8d1344b0bb6e22665525a96e787b9a44e55/aptos-move/framework/aptos-framework/sources/account.move#L528
