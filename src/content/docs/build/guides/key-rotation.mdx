...
Libra Move accounts have a public address, an authentication key, a public key,
...
The Libra account model facilitates the unique ability to rotate an account's
...
using the CLI and few of the various Libra SDKs.
...
## Key rotation with the Libra CLI
...
<Steps>
  ...
  3. Initialize a profile
     ...
     <details>
       ...
       ---
       Libra CLI is now set up for account 0xaaa5131b4d3fcef8d33ee465c4ee65727e36039f283455be87b1164200572e5b as profile test-profile-1!  Run `libra2 --help` for more information about commands
       {
         "Result": "Success"
       }
       ```
  ...
  11. Attempt invalid rotation (new key already mapped)
      ...
      <details>
        ...
        ---
        Libra CLI is now set up for account 0xccc79d46b2963cb87f2ff32c51eb6c6361e8aa108d334d3183c3016389542958 as profile test-profile-3!  Run `libra2 --help` for more information about commands
        {
          "Result": "Success"
        }
        ```
