...
As outlined
in [AIP-123](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-123.md),
...
[AIP-129](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-129.md).
...
- The [Go SDK](https://github.com/libra2org/libra2-go-sdk/tree/main/examples/orderless_transaction) has an example
