...
<Aside type="note">
  **Keyless Account Scoping**
  ...
  Use of the \*\*_Libra Keyless Integration Guide_\*\* will allow for the integration of keyless accounts directly into your application. This means that blockchain accounts are scoped to your application's domain (logging in with your Google account on dApp A and logging in with your Google account on dApp B will create separate accounts). Stay tuned for more to come on Libra’ plan to allow Keyless accounts to be used portably across applications.

  To provide feedback, get support, or be a design partner as we enhance Libra Keyless, join us here: https://t.me/+h5CN-W35yUFiYzkx
</Aside>
...
2. **Install the Libra TypeScript SDK.**
...
<Steps>
  ...
  2. Step 2. Install the Libra TypeScript SDK
  ...
  3. Step 3. Client Integration Steps
     ...
     #### 4. Submit transactions to the Libra blockchain
