...
Libra2 Keyless supports the following IdPs and IAM providers on our network(s). Support for additional IdPs to come. Please reach out if you have need for coverage for a specific use case.
...
If your identity provider is marked as "Federated Only", you will need to follow the instructions for [Federated Keyless](/build/guides/libra2-keyless/federated-keyless).

To integrate Libra2 Keyless into your dApp, you must register your dApp with at least one of the available identity providers via their OIDC registration process. Each respective registration process will assign a Client ID to your application, which will serve as an identifier for your application in the Keyless architecture.
...
<Steps>
  ...
  4. Step 4: Register Your Application
     ...
     1. In the left sidebar, navigate to "APIs & Services" > "Credentials."
        ![Google Credentials navigation screenshot](~/images/libra2-keyless/google-credentials-nav.png "Google Credentials navigation screenshot")

     2. Click on "Create Credentials" and select "OAuth client ID."
        ![Google create credentials screenshot](~/images/libra2-keyless/google-create-credentials.png "Google create credentials screenshot")
...
<Steps>
  1. Step 1: Sign in to Apple Developer Account
     ...
     3. Enroll in the Apple Developer Program if not already.
        ![Apple developer program enrollment screenshot](~/images/libra2-keyless/apple-dev-program.png "Apple developer program enrollment screenshot")
