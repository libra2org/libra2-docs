...
<Steps>
  ...
  2. Step 2. Register the JSON Web Key Set (JWKS) on-chain
     ...
     const aptos = new Libra(new LibraConfig({ network: Network.DEVNET })); // Configure your network here
     ...
     ```shellscript
     git clone https://github.com/libra2org/aptos-ts-sdk
     cd aptos-ts-sdk
  ...
  3. Step 3. Follow the Libra Keyless integration guide
     ...
     [Libra Keyless Integration Guide - Step 2](/build/guides/libra2-keyless/integration-guide#step-2-install-the-aptos-typescript-sdk)
</Steps>
