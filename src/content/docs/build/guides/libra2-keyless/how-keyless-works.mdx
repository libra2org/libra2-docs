...
Libra2 Keyless enables a dApp to **derive** and **access** a blockchain account for a user who successfully signed in to the dApp via an OIDC provider (e.g., Google). Importantly, this blockchain account is **scoped to the dApp**. This means other dApps, who can similarly sign-in the same user, via the same OIDC provider, are not able to access this account and instead get their own account.
...
![Keyless overview](~/images/libra2-keyless/keyless-overview.png "Keyless overview")
...
![Keyless account diagram](~/images/libra2-keyless/keyless-account.png "Keyless account diagram")
...
![Keyless proof diagram](~/images/libra2-keyless/keyless-proof.png "Keyless proof diagram")
...
![Keyless relation diagram](~/images/libra2-keyless/keyless_relation.png "Keyless relation diagram")
...
![Keyless signing diagram](~/images/libra2-keyless/keyless-signing.png "Keyless signing diagram")
