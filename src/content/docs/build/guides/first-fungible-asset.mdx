...
You can find the [Move reference for Fungible Assets](/move-reference?branch=mainnet\&page=aptos-framework%2Fdoc%2Ffungible_asset.md) for more details on the function signatures and implementation details.
