---
title: "Smart Contracts on Aptos"
---
...
<CardGrid>
  <LinkCard href="smart-contracts/why-move" title="Why Move?" description={"Learn why Aptos uses the Move Language"} />
  {/* <LinkCard href="smart-contracts/prover" title="Move Prover" description={"Formal specification and verification of Move contracts on Aptos"} /> */}
  ...
  <LinkCard href="smart-contracts/objects" title="Objects" description={"Learn how to use the Object standard on Aptos to create composable and flexible primitives on chain"} />
</CardGrid>
...
<CardGrid>
  ...
  <LinkCard href="guides/first-move-module" title="Your first Move Module" description={"A `hello_blockchain` example of how to publish your first move module"} />
</CardGrid>
