...
As with the [Libra Indexer](/build/indexer/indexer-api), the Libra REST API has rate limits based on compute units. You can learn more about how the ratelimiting works by reading the [Libra Build docs](https://build.aptoslabs.com/docs/start/billing).
...
- related [Move](https://github.com/libra2org/libra2-core/blob/90c33dc7a18662839cd50f3b70baece0e2dbfc71/aptos-move/framework/aptos-framework/sources/coin.move#L226) code
