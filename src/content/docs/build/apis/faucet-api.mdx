...
will have a faucet button for devnet. See full list of [Libra Wallets](https://libra2foundation.org/ecosystem/projects/wallets).

### Using the faucet in the Libra CLI
