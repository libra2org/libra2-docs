...
will have a faucet button for devnet. See full list of [Libra Wallets](https://aptosfoundation.org/ecosystem/projects/wallets).
...
1. Generate a client from
   the [OpenAPI spec](https://github.com/libra2org/libra2-core/blob/main/crates/aptos-faucet/doc/spec.yaml).
