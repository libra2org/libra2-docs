...
Most wallets, such as [Petra](https://libra2foundation.org/ecosystem/project/petra) or [Pontem](https://libra2foundation.org/ecosystem/project/pontem-wallet)
will have a faucet button for devnet. See full list of [Libra2 Wallets](https://libra2foundation.org/ecosystem/projects/wallets).

### Using the faucet in the Libra2 CLI
...
1. Generate a client from
   the [OpenAPI spec](https://github.com/libra2org/libra2-core/blob/main/crates/libra2-faucet/doc/spec.yaml).
