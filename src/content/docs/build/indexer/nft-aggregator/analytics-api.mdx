...
<Aside type="note">
  The REST API provides collection and marketplace-level insights across the Libra2 ecosystem.
</Aside>
...
> **Base URL:** `https://api.mainnet.libra2labs.com/v1/analytics/nft`
...
```shellscript
curl "https://api.mainnet.libra2labs.com/v1/analytics/nft/marketplace/total_sales_count?marketplace=topaz"
```
...
```shellscript
curl "https://api.mainnet.libra2labs.com/v1/analytics/nft/collection/total_sales_count?collection_id=123"
```
...
```shellscript
curl "https://api.mainnet.libra2labs.com/v1/analytics/nft/collection/top_buyer?collection_id=123&limit=5"
```
...
```shellscript
curl "https://api.mainnet.libra2labs.com/v1/analytics/nft/collection/top_seller?collection_id=123&limit=5"
```
...
```shellscript
curl "https://api.mainnet.libra2labs.com/v1/analytics/nft/collection/total_sales_volume?collection_id=123"
```
...
```shellscript
curl "https://api.mainnet.libra2labs.com/v1/analytics/nft/collection/list_by_volume?limit=10&offset=0&time_period=1d"
```
...
```shellscript
curl "https://api.mainnet.libra2labs.com/v1/analytics/nft/collection/list_by_sales?limit=10&offset=0&time_period=1d"
```
...
```shellscript
curl "https://api.mainnet.libra2labs.com/v1/analytics/nft/collection/list_by_floor_price?limit=10&offset=0&time_period=1d"
```
...
```shellscript
curl "https://api.mainnet.libra2labs.com/v1/analytics/nft/collection/unique_holders_count?collection_id=<collection_id>"
```
