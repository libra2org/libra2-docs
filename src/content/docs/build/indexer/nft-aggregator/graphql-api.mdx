...
<Aside type="note">
  The GraphQL API provides real-time access to NFT marketplace activity across the Libra2 ecosystem.
</Aside>

## Endpoints

- **Hasura Console:** [API Explorer](https://cloud.hasura.io/public/graphiql?endpoint=https://api.mainnet.libra2labs.com/nft-aggregator/v1/graphql)
- **Mainnet Endpoint:**\
  `https://api.mainnet.libra2labs.com/nft-aggregator/v1/graphql`
...
<GraphQLEditor
  ...
  endpoint="https://api.mainnet.libra2labs.com/nft-aggregator-staging/v1/graphql"
/>
