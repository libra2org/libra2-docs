...
We've built a **universal NFT aggregator** for the Libra2 ecosystem - normalized activity across all major marketplaces, including **Tradeport**, **Wapal**, **Bluemove**, **Rarible**, and more. We also maintain historical data for deprecated marketplaces like **Topaz**.
...
- Hasura Console: https://cloud.hasura.io/public/graphiql?endpoint=https://api.mainnet.libra2labs.com/nft-aggregator/v1/graphql

For direct GraphQL queries to the Libra2-Labs hosted Indexer API, use these endpoints:

- Mainnet Graphql Endpoint: https://api.mainnet.libra2labs.com/nft-aggregator/v1/graphql
