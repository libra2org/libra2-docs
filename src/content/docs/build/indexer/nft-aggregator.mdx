...
We've built a **universal NFT aggregator** for the Libra ecosystem - normalized activity across all major marketplaces, including **Tradeport**, **Wapal**, **Bluemove**, **Rarible**, and more. We also maintain historical data for deprecated marketplaces like **Topaz**.
...
For direct GraphQL queries to the Libra-Labs hosted Indexer API, use these endpoints:
