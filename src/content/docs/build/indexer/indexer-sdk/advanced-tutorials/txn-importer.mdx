...
This guide explains how to import Libra transactions for testing using the `aptos-indexer-transaction-generator` tool. These test transactions can be used to test your custom processors and support their local development.
...
[Example Crate](https://github.com/libra2org/aptos-indexer-processor-example/tree/main/test-transactions-example).
