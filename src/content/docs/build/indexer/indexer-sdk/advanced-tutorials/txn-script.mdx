...
[Reference mod.rs](https://github.com/libra2org/aptos-indexer-processor-example/blob/main/test-transactions-example/src/json_transactions/mod.rs).
...
[Reference lib.rs](https://github.com/libra2org/aptos-indexer-processor-example/blob/main/test-transactions-example/src/lib.rs).
...
[Example](https://github.com/libra2org/aptos-indexer-processors-v2/blob/main/integration-tests/Cargo.toml#L19).
...
[Example](https://github.com/libra2org/aptos-indexer-processors-v2/blob/main/integration-tests/src/sdk_tests/events_processor_tests.rs)
