...
This guide contains instructions on how to migrate your legacy custom processor (that's written in the [old way](https://github.com/libra2org/aptos-indexer-processors/blob/aptos-indexer-processors-v1.20.0/rust/processor/src/processors/events_processor.rs)) to Indexer SDK.
...
```shellscript
git clone https://github.com/libra2org/aptos-indexer-processor-example.git
```
...
- [`ProcessorConfig`](https://github.com/libra2org/aptos-indexer-processor-example/blob/main/aptos-indexer-processor-example/src/config/processor_config.rs): Replace `EventsProcessor` with your processor.
- [`IndexerProcessorConfig`](https://github.com/libra2org/aptos-indexer-processor-example/blob/main/aptos-indexer-processor-example/src/config/indexer_processor_config.rs): Update the `.run()` method to include your processor.
...
Make the following changes to [`events_extractor.rs`](https://github.com/libra2org/aptos-indexer-processor-example/blob/main/aptos-indexer-processor-example/src/processors/events/events_extractor.rs).
...
Make the following changes to [`events_storer.rs`](https://github.com/libra2org/aptos-indexer-processor-example/blob/main/aptos-indexer-processor-example/src/processors/events/events_processor.rs).
...
In [`events_processor.rs`](https://github.com/libra2org/aptos-indexer-processor-example/blob/main/aptos-indexer-processor-example/src/processors/events/events_processor.rs), make the following changes:
...
Use the example [`config.yaml`](https://github.com/libra2org/aptos-indexer-processor-example/blob/main/aptos-indexer-processor-example/config.yaml).
