...
You can explore the [full list of processors](https://github.com/libra2org/libra2-indexer-processors-v2/blob/main/processor/src/db/schema.rs).

The Libra2 core processors and the [Quickstart Guide](/build/indexer/indexer-sdk/quickstart) use [PostgreSQL](https://www.postgresql.org/) as the database and [Diesel](https://diesel.rs/) as the ORM.
