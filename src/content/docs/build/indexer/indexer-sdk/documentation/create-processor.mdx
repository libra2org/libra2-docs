...
You can see a full example of a processor that indexes raw Libra events in [`libra2-indexer-processor-example`](https://github.com/libra2org/libra2-indexer-processor-example/blob/main/libra2-indexer-processor-example/src/processors/events/events_processor.rs).
