...
This is the processor you want to run. You can see what processors are available [here](https://github.com/libra2org/aptos-indexer-processors-v2/tree/main/processor/src/processors). Some examples:
