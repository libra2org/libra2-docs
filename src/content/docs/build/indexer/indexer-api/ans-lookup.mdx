---
title: "Get Libra Name From Address"
---
...
`getNameFromAddress` looks for a registered domain name for a given account. For example, a user could register their account with the Libra Name Service to be associated to `love.apt`. You can learn more by going to https://www.libra2names.com/.
