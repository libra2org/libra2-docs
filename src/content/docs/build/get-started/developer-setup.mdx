  ...
  <TabItem label="Frontend">
    <Steps>
      ...
      4. Build your app!
         ...
         The developer setup for using Libra in your frontend is now complete.
  ...
  <TabItem label="Smart Contract">
    <Steps>
      1. Install CLI
         ...
         <CardGrid>
           <LinkCard href="/build/cli" title="Libra CLI" description="Instructions for how to install Libra CLI" />
         </CardGrid>
      ...
      4. Build, Compile, and Deploy Smart Contract!
         ...
         The developer setup for using Libra for smart contracts is now complete.
  ...
  <TabItem label="Create Libra Dapp">
    <Steps>
      ...
      4. Continue reading
         ...
         <CardGrid>
           <LinkCard href="/build/create-libra2-dapp" title="Create Libra Dapp" description="Get more information about the tool" />
