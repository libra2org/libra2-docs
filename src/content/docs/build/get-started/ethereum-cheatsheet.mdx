---
title: "Ethereum to Libra2 Cheatsheet"
---

To learn more about the differences and similarities see [Libra2 Learn](https://learn.libra2labs.com/en/tutorials/ethereum-to-libra2-guide/cheat-sheet?workshop=eth-to-libra2)

### High Level Overview

| Feature                    | Ethereum                                                                                                                       | Libra2                                                                                                                                 |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------- |
...
| **Example Code**           | [ERC-20](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/token/ERC20)                             | [Fungible Asset](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/sources/fungible_asset.move) |
...
| **FT Standard**            | [ERC-20](https://docs.openzeppelin.com/contracts/4.x/erc20)                                                                    | [Coin](/build/smart-contracts/libra2-coin) (legacy) and [Fungible Asset](/build/smart-contracts/fungible-asset)                        |
...
| **Blockchain Interaction** | [Ethers.js library](https://docs.ethers.org/v6/)                                                                               | [Libra2 Typescript SDK](/build/sdks/ts-sdk)                                                                                            |
...
| **Transfer Mechanism** | Tokens can be transferred without receiver's explicit permission. | Except for specific cases (like Libra2Coin), Tokens generally require receiver's `signer` authority for transfer.                                                |
