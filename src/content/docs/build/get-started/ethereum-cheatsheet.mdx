---
title: "Ethereum to Libra Cheatsheet"
---

To learn more about the differences and similarities see [Libra Learn](https://learn.libra2labs.com/en/tutorials/ethereum-to-libra2-guide/cheat-sheet?workshop=eth-to-libra2)

### High Level Overview

| Feature                    | Ethereum                                                                                                                       | Libra                                                                                                                                 |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------- |
...
| **Blockchain Interaction** | [Ethers.js library](https://docs.ethers.org/v6/)                                                                               | [Libra Typescript SDK](/build/sdks/ts-sdk)                                                                                            |
...
| **Transfer Mechanism** | Tokens can be transferred without receiver's explicit permission. | Except for specific cases (like LibraCoin), Tokens generally require receiver's `signer` authority for transfer.                                                |
