...
The Aptos Node Health Checker (NHC) service can be used to check the health of your node(s). See [Node Health Checker](/ja/network/nodes/measure/node-health-checker) for full documentation on the NHC.
