...
The [Aptos CLI](/ja/build/cli) supports two kinds of restore operations for Aptos nodes:
...
disable the pruner by following the instructions in the [disabling the ledger pruner](/ja/network/nodes/configure/data-pruning) section before
