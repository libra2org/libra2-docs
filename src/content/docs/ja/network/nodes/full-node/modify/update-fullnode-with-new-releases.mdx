...
3. Download the new [genesis.blob](/ja/network/nodes/configure/node-files-all-networks/node-files-devnet.mdx#genesisblob) file and the new [waypoint](/ja/network/nodes/configure/node-files-all-networks/node-files-devnet.mdx#waypointtxt).
