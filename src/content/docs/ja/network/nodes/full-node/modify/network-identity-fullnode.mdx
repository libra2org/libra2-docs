...
<Aside type="caution">
  Before you proceed, make sure that you already know how to start your local PFN. See [Run a PFN](/ja/network/nodes/full-node) for detailed documentation.
</Aside>
...
First, use the [Aptos CLI](/ja/build/cli) (`aptos`) to produce a hex encoded static
