...
If you want to configure your node with a static identity, first see the [Generate a PFN Identity](/ja/network/nodes/full-node/modify/network-identity-fullnode) tutorial
to generate a static identity, and then follow the below instructions to configure your Terraform file.

1. Generate a static identity for your PFN by following the guide: [Creating a static identity for a PFN](/ja/network/nodes/full-node/modify/network-identity-fullnode.mdx#generate-a-static-identity).
...
[Customize PFN Networks](/ja/network/nodes/full-node/modify/fullnode-network-connections) for more information.
...
<Aside type="note">
  **Verify your PFN**<br />
  If you want to verify that your PFN is running correctly, you can follow the instructions in the [Verify a PFN](/ja/network/nodes/full-node/verify-pfn) guide.
</Aside>
