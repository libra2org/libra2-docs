...
<Aside type="note">
  ...
  See [**Running Validator Node**](/ja/network/nodes/validator-node/deploy-nodes).
</Aside>
...
[**Cloning aptos-core**](/ja/network/nodes/building-from-source.mdx#clone-the-aptos-core-repo) section).
