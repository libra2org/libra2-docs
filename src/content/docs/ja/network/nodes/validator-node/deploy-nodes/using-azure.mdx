...
You have now completed setting up your validator and VFN using Azure. Proceed to [Connect Nodes](/ja/network/nodes/validator-node/connect-nodes) for the next steps.
