...
All data exposed by the [Indexer API](/ja/build/indexer/aptos-hosted) is initially indexed using custom processors.
...
The Aptos core processors and the [Quickstart Guide](/ja/build/indexer/indexer-sdk/quickstart) use [PostgreSQL](https://www.postgresql.org/) as the database and [Diesel](https://diesel.rs/) as the ORM.
