...
新しいコンパイラはMove 2(Move言語の最新リビジョン)をサポートしています.Move 2の新機能については,[ブック内のリリースページ](/ja/build/smart-contracts/book/move-2)をご覧ください.Aptos CLI v6.0.0以降,この言語バージョンと新しいコンパイラがデフォルトとなっています.
