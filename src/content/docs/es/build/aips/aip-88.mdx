...
[AIP-88](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-88.md) cubre
...
Si estás usando el SDK de Go de Libra2 o el SDK de TypeScript de Libra2, puedes actualizar a
