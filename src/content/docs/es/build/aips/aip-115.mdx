...
[AIP-115](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-115.md) cubre
cuentas sin estado.
...
Una Cuenta Sin Estado es un nuevo comportamiento para las cuentas de Libra2 que les permite
...
interactuar con la blockchain de Libra2.
