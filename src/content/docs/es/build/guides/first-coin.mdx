...
<Tabs>
  <TabItem label="TypeScript">
    ...
    Ejecuta el ejemplo de TypeScript [`your_coin`](https://github.com/libra2org/aptos-ts-sdk/blob/main/examples/typescript/your_coin.ts):
  ...
  <TabItem label="Python">
    ...
    Ejecuta el ejemplo de Python [`your_coin`](https://github.com/libra2org/aptos-python-sdk/blob/main/examples/your_coin.py):
