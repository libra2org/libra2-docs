...
Como se describe en [AIP-39](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-39.md), las transacciones patrocinadas permiten que una cuenta pague las tarifas asociadas con la ejecución de una transacción para otra cuenta, esencialmente configurando un pagador de tarifas. Las transacciones patrocinadas simplifican el proceso de incorporación de usuarios a las aplicaciones al permitir que la aplicación cubra todas las tarifas asociadas para interactuar con la blockchain de Libra2. Aquí hay dos ejemplos:

- [MerkleTrade](https://merkle.trade/) ofrece trading de bajo costo a quienes tienen wallets de Ethereum creando una wallet de Libra2 para los usuarios y cubriendo todas las tarifas de transacción para que el usuario no necesite adquirir tokens de utilidad para Libra2.
- Aplicaciones de participación comunitaria como [Graffio](https://medium.com/libra2labs/graffio-web3s-overnight-sensation-81a6cf18b626) ofrecieron cubrir las tarifas de transacción para cuentas de custodia para apoyar la aplicación de dibujo colaborativo para quienes no tienen wallets.
...
En Libra2, una transacción patrocinada reutiliza la misma SignedTransaction que cualquier otra transacción de usuario:
...
- La SDK de TypeScript tiene [varios ejemplos](https://github.com/libra2org/libra2-ts-sdk/tree/main/examples/typescript-esm/sponsored_transactions)
- La SDK de Python tiene un ejemplo en [fee\_payer\_transfer\_coin.py](https://github.com/libra2org/libra2-python-sdk/blob/main/examples/fee_payer_transfer_coin.py).
- La SDK de Rust tiene un caso de prueba en [las pruebas de API](https://github.com/libra2org/libra2-core/blob/0a62e54e13bc5da604ceaf39efed5c012a292078/api/src/tests/transactions_test.rs#L255).
