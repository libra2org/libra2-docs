...
- La SDK de TypeScript tiene [varios ejemplos](https://github.com/libra2org/aptos-ts-sdk/tree/main/examples/typescript-esm/sponsored_transactions)
- La SDK de Python tiene un ejemplo en [fee\_payer\_transfer\_coin.py](https://github.com/libra2org/aptos-python-sdk/blob/main/examples/fee_payer_transfer_coin.py).
