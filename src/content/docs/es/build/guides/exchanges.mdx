...
- Un estándar anterior [Coin](/build/smart-contracts/aptos-coin) usado por activos en Libra.
...
representado como un nombre de struct e.g. `0x1::aptos_coin::LibraCoin` para `APT`.
    ...
    "events": [
      {
        ...
        "data": {
          "coin_type": "0x1::aptos_coin::LibraCoin",
...
- [`0x1::aptos_account::transfer_coins<CoinType>(dirección de receptor, cantidad)`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/aptos_account.move#L108-L112) - Transferir una moneda a otra cuenta.
- [`0x1::aptos_account::batch_transfer_coins<CoinType>(direcciones de receptores, cantidades)`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/aptos_account.move#L93-L106) - Transferir una moneda a múltiples cuentas.
- [`0x1::aptos_account::transfer(dirección de receptor, cantidad)`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/aptos_account.move#L74-L91) - Transferir específicamente APT a otra cuenta.
...
Para probar las verificaciones de balance, puedes verificar el balance para la cuenta `0x5` para el activo `0x1::aptos_coin::LibraCoin`.
...
| -------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Tether USD           | USDt         | [0x357b0b74bc833e95a115ad22604854d6b0fca151cecd94111770e5d6ffc9dc2b](https://explorer.aptoslabs.com/fungible_asset/0x357b0b74bc833e95a115ad22604854d6b0fca151cecd94111770e5d6ffc9dc2b?network=mainnet)               | [Libra Foundation](https://aptosfoundation.org/currents/global-finance-moves-faster-on-aptos) |
