...
<Steps>
  1. Configurar el Cliente
     ...
     Este objeto `aptos` nos permite interactuar con la blockchain de Libra (financiar cuentas, crear activos, enviar transacciones, etc.).
...
<Steps>
  ...
  7. Ver tus Transacciones en el Explorador
     ...
     2. Visita [Libra Explorer](https://explorer.aptoslabs.com/?network=devnet)
