...
[`aptos_account::transfer`](https://github.com/libra2org/libra2-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/aptos-move/framework/aptos-framework/sources/aptos_account.move#L18)
o explícitamente a través de
[`aptos_account::create_account`](https://github.com/libra2org/libra2-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/aptos-move/framework/aptos-framework/sources/aptos_account.move#L13).

Al crearse, una [cuenta de Libra](https://github.com/libra2org/libra2-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/aptos-move/framework/aptos-framework/sources/account.move#L23) contiene:

- Un [recurso que contiene la moneda de Libra](https://github.com/libra2org/libra2-core/blob/60751b5ed44984178c7163933da3d1b18ad80388/aptos-move/framework/aptos-framework/sources/coin.move#L50)
...
el campo `hash` [field](https://github.com/libra2org/libra2-core/blob/9b85d41ed8ef4a61a9cd64f9de511654fcc02024/ecosystem/python/sdk/aptos_sdk/client.py#L138).
...
Ambos el [SDK de Typescript](https://github.com/libra2org/aptos-ts-sdk/blob/main/src/api/transactionSubmission/simulate.ts) y [SDK de Python](https://github.com/libra2org/aptos-python-sdk/blob/main/examples/simulate_transfer_coin.py) soportan la API de simulación. Tenga en cuenta que la salida y el gas utilizado pueden cambiar basado en el estado de la cuenta. Para las estimaciones de gas, recomendamos que el monto máximo de gas sea mayor que el monto citado por esta API.
...
Libra tiene una
estándar [Activo Fungible](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/fungible_asset.move).
...
la función [`primary_fungible_store::transfer`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/primary_fungible_store.move#L142)
.
Para cualquier `FungibleStore`
s, [`fungible_asset::transfer`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/fungible_asset.move#L347)
...
[Tipo de moneda](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/coin.move).
...
Las monedas se almacenan dentro de una cuenta bajo el recurso `CoinStore<T>`. Al crearse una cuenta, cada usuario tiene el recurso `CoinStore<0x1::aptos_coin::LibraCoin>`
...
la función [`aptos_account::transfer_coins`](https://github.com/libra2org/libra2-core/blob/d1610e1bb5214689a37a9cab59cf9254e8eb2be1/aptos-move/framework/aptos-framework/sources/aptos_account.move#L92)
para todas las monedas
y [`aptos_account::transfer`](https://github.com/libra2org/libra2-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/aptos-move/framework/aptos-framework/sources/aptos_account.move#L18)
...
const coinType = "0x1::aptos_coin::LibraCoin";
  ...
  "changes": [
    {
      ...
      "data": {
        "type": "0x1::coin::CoinStore<0x1::aptos_coin::LibraCoin>",
        "data": {
          "coin": {
            "value": "1000"
          },
...
URL: `https://{rest_api_server}/accounts/{address}/events/0x1::coin::CoinStore<0x1::aptos_coin::LibraCoin>/withdraw_events`
...
<Aside type="note">
  ...
  suficientes. `0x1::aptos_coin::LibraCoin`, sin embargo, requiere
...
3. Una tarifa de gas `2200` de `0x1::aptos_coin::LibraCoin` de la cuenta de transacción enviada `0x810026ca8291dd88b5b30a1d3ca2edd683d33d06c4a7f7c451d96f6d47bc5e8b`
