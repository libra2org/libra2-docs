...
Esta guía explica cómo construir un sistema de gestión de transacciones que pueda escalar en la blockchain de Libra.

## Antecedentes

En Libra, las transacciones se asignan a una cuenta en términos de la entidad que firma o autoriza esa transacción y proporciona un número de secuencia basado en la cuenta. Cuando la red de Libra recibe una nueva transacción, se siguen varias reglas respecto a esto:
...
Para aprovechar completamente la blockchain para un rendimiento masivo, usar una sola cuenta de usuario no es suficiente. En su lugar, Libra soporta el concepto de cuentas worker que pueden compartir la responsabilidad de enviar trabajo a través de una cuenta compartida, también conocida como cuenta de recurso.
