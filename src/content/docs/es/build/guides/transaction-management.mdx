...
Esta guía explica cómo construir un sistema de gestión de transacciones que pueda escalar en la blockchain de Libra2.

## Antecedentes

En Libra2, las transacciones se asignan a una cuenta en términos de la entidad que firma o autoriza esa transacción y proporciona un número de secuencia basado en la cuenta. Cuando la red de Libra2 recibe una nueva transacción, se siguen varias reglas respecto a esto:
...
- Python
  - [Gestor de números de secuencia](https://github.com/libra2org/libra2-core/pull/7987)
  - [Gestor de transacciones](https://github.com/libra2org/libra2-core/pull/7987)
- [Contrato inteligente worker-líder](https://github.com/libra2org/libra2-core/pull/7986)
...
Para aprovechar completamente la blockchain para un rendimiento masivo, usar una sola cuenta de usuario no es suficiente. En su lugar, Libra2 soporta el concepto de cuentas worker que pueden compartir la responsabilidad de enviar trabajo a través de una cuenta compartida, también conocida como cuenta de recurso.
