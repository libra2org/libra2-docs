...
Las cuentas de Libra Move tienen una dirección pública, una clave de autenticación, una clave pública,
...
El modelo de cuenta de Libra facilita la capacidad única de rotar la clave privada
...
## Rotación de claves con la CLI de Libra
...
<Steps>
  ...
  4. Busca la dirección
     ...
     Ahora que hay una cuenta en la cadena de Libra asociada con la clave de autenticación,
