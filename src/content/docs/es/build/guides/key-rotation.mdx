...
[aquí](https://github.com/libra2org/aptos-ts-sdk/blob/main/examples/typescript/rotate_key.ts).
...
Ver el ejemplo completo para este código
[aquí](https://github.com/libra2org/aptos-python-sdk/blob/main/examples/rotate_key.py).
