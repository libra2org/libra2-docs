...
Las cuentas de Libra2 Move tienen una dirección pública, una clave de autenticación, una clave pública,
...
El modelo de cuenta de Libra2 facilita la capacidad única de rotar la clave privada
...
CLI `libra2` actualmente no soporta rotaciones de claves no probadas.
...
## Rotación de claves con la CLI de Libra2
...
<Steps>
  ...
  4. Busca la dirección
     ...
     Ahora que hay una cuenta en la cadena de Libra2 asociada con la clave de autenticación,
     puedes buscar la dirección de la cuenta usando `libra2 account lookup-address`:
...
[aquí](https://github.com/libra2org/libra2-ts-sdk/blob/main/examples/typescript/rotate_key.ts).
...
Ver el ejemplo completo para este código
[aquí](https://github.com/libra2org/libra2-python-sdk/blob/main/examples/rotate_key.py).
