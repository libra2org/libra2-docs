---
title: "Usa Oráculos en tus Aplicaciones Libra"
---

import { Aside } from '@astrojs/starlight/components';

Esta guía de referencia presenta varios Oráculos que puedes utilizar al construir en Libra. Los oráculos suministran datos offchain a la blockchain, permitiendo que los contratos inteligentes accedan a una amplia gama de información.
...
## Cómo Usar Datos en Tiempo Real de Pyth en Contratos Libra

Esta guía explica cómo usar datos en tiempo real de Pyth en aplicaciones Libra.
...
Las direcciones nombradas de `pyth`, `wormhole` y `deployers` deben definirse en tiempo de compilación. Estas direcciones se usan para interactuar con el contrato de Pyth en Libra.
...
Consulta [Direcciones de Contrato de Libra](https://docs.pyth.network/price-feeds/contract-addresses/libra2) para la lista completa de direcciones de contrato en diferentes redes de Libra.
...
module example::example {
    ...
    public fun get_btc_usd_price(user: &signer, pyth_price_update: vector<vector<u8>>): Price {
        ...
        // Nota: Libra usa el ID de feed de precios de Pyth sin el prefijo `0x`.
...
Puedes encontrar estos recursos adicionales útiles para desarrollar tu aplicación Libra.

## Feeds Patrocinados en Libra

Los feeds de precios listados en la tabla a continuación están actualmente patrocinados en **Libra mainnet**.
...
La [referencia de API de Libra](https://docs.pyth.network/price-feeds/api-reference/libra2) te permite explorar interactivamente la API completa del contrato de Pyth.
