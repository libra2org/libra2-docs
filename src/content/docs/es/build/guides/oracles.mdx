...
Consulta [Direcciones de Contrato de Libra](https://docs.pyth.network/price-feeds/contract-addresses/aptos) para la lista completa de direcciones de contrato en diferentes redes de Libra.
...
La [referencia de API de Libra](https://docs.pyth.network/price-feeds/api-reference/aptos) te permite explorar interactivamente la API completa del contrato de Pyth.
