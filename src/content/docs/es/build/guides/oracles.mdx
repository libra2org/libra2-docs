---
title: "Usa Oráculos en tus Aplicaciones Libra2"
---

import { Aside } from '@astrojs/starlight/components';

Esta guía de referencia presenta varios Oráculos que puedes utilizar al construir en Libra2. Los oráculos suministran datos offchain a la blockchain, permitiendo que los contratos inteligentes accedan a una amplia gama de información.
...
## Cómo Usar Datos en Tiempo Real de Pyth en Contratos Libra2

Esta guía explica cómo usar datos en tiempo real de Pyth en aplicaciones Libra2.
...
```toml copy
[dependencies]
Pyth = { git = "https://github.com/pyth-network/pyth-crosschain.git", subdir = "target_chains/libra2/contracts", rev = "main" }
```

Las direcciones nombradas de `pyth`, `wormhole` y `deployers` deben definirse en tiempo de compilación. Estas direcciones se usan para interactuar con el contrato de Pyth en Libra2.
...
Consulta [Direcciones de Contrato de Libra2](https://docs.pyth.network/price-feeds/contract-addresses/libra2) para la lista completa de direcciones de contrato en diferentes redes de Libra2.
...
module example::example {
    ...
    public fun get_btc_usd_price(user: &signer, pyth_price_update: vector<vector<u8>>): Price {
        ...
        // Nota: Libra2 usa el ID de feed de precios de Pyth sin el prefijo `0x`.
...
Puedes encontrar estos recursos adicionales útiles para desarrollar tu aplicación Libra2.

## Feeds Patrocinados en Libra2

Los feeds de precios listados en la tabla a continuación están actualmente patrocinados en **Libra2 mainnet**.
...
La [referencia de API de Libra2](https://docs.pyth.network/price-feeds/api-reference/libra2) te permite explorar interactivamente la API completa del contrato de Pyth.

### Aplicaciones de Ejemplo

- [Contrato on-chain mínimo](https://github.com/pyth-network/pyth-examples/blob/main/price_feeds/libra2/fetch_btc_price/sources/example.move), que actualiza y devuelve el precio BTC/USD de los feeds de precios de Pyth.
- [Acuñar NFT](https://github.com/pyth-network/pyth-examples/tree/main/price_feeds/libra2/mint_nft) que usa feeds de precios de Pyth para acuñar un NFT.
