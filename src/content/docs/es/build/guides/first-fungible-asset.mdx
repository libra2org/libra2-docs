...
Aquí modificaremos, desplegaremos y probaremos el ejemplo del contrato [FACoin](https://github.com/libra2org/libra2-ts-sdk/blob/main/examples/typescript/move/facoin/sources/fa_coin.move) para ver cómo funciona el Estándar de Activo Funciable. Si estás escribiendo tu propio contrato de activo fungible, también puedes consultar el ejemplo de contrato Stablecoin [aquí](https://learn.libra2labs.com/en/code-examples/stablecoin).
...
<Steps>
  ...
  10. Ejecuta your\_fungible\_asset.
      ...
      Para ejecutar la compilación, debes tener el CLI `libra2` instalado.
      ...
      ACTUALIZANDO DEPENDENCIA GIT https://github.com/libra2org/libra2-core.git
      INCLUYENDO DEPENDENCIA Libra2Framework
      INCLUYENDO DEPENDENCIA Libra2Stdlib
