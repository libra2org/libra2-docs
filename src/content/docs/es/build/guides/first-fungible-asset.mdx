...
Aquí modificaremos, desplegaremos y probaremos el ejemplo del contrato [FACoin](https://github.com/libra2org/aptos-ts-sdk/blob/main/examples/typescript/move/facoin/sources/fa_coin.move) para ver cómo funciona el Estándar de Activo Funciable. Si estás escribiendo tu propio contrato de activo fungible, también puedes consultar el ejemplo de contrato Stablecoin [aquí](https://learn.aptoslabs.com/en/code-examples/stablecoin).
