...
```shellscript filename="Terminal"
cd ~/libra2-core/aptos-move/move-examples/fungible_asset/managed_fungible_asset
...
```shellscript filename="Terminal"
cd ~/libra2-core/aptos-move/move-examples/fungible_asset/multisig_managed_coin
aptos move publish --named-addresses example_addr=default
```
