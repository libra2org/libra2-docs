---
title: "Hoja de Referencia de Ethereum a Libra"
---

Para aprender más sobre las diferencias y similitudes ve [Aprende Libra](https://learn.libra2labs.com/en/tutorials/ethereum-to-libra2-guide/cheat-sheet?workshop=eth-to-libra2)

### Visión General de Alto Nivel

| Característica             | Ethereum                                                                                                                       | Libra                                                                                                                                 |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------- |
...
| **Interacción con Blockchain** | [Biblioteca Ethers.js](https://docs.ethers.org/v6/)                                                                               | [SDK de TypeScript de Libra](/build/sdks/ts-sdk)                                                                                            |
...
| **Mecanismo de Transferencia** | Los tokens pueden ser transferidos sin el permiso explícito del receptor. | Excepto para casos específicos (como LibraCoin), los Tokens generalmente requieren autoridad `signer` del receptor para transferencia.                                                |
