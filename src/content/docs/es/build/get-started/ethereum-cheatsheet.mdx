---
title: "Hoja de Referencia de Ethereum a Libra2"
---

Para aprender más sobre las diferencias y similitudes ve [Aprende Libra2](https://learn.libra2labs.com/en/tutorials/ethereum-to-libra2-guide/cheat-sheet?workshop=eth-to-libra2)

### Visión General de Alto Nivel

| Característica             | Ethereum                                                                                                                       | Libra2                                                                                                                                 |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------- |
...
| **Código de Ejemplo**      | [ERC-20](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/token/ERC20)                             | [Activo Fungible](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/sources/fungible_asset.move) |
...
| **Estándar FT**            | [ERC-20](https://docs.openzeppelin.com/contracts/4.x/erc20)                                                                    | [Coin](/build/smart-contracts/libra2-coin) (legacy) y [Activo Fungible](/build/smart-contracts/fungible-asset)                        |
...
| **Interacción con Blockchain** | [Biblioteca Ethers.js](https://docs.ethers.org/v6/)                                                                               | [SDK de TypeScript de Libra2](/build/sdks/ts-sdk)                                                                                            |

<br />

### Comparando Estándares de Tokens en Detalle

|                        | Solidity                                                               | Move (Libra2)                                                                                                                                                         |
| ---------------------- | ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| **Mecanismo de Transferencia** | Los tokens pueden ser transferidos sin el permiso explícito del receptor. | Excepto para casos específicos (como Libra2Coin), los Tokens generalmente requieren autoridad `signer` del receptor para transferencia.                                                |
