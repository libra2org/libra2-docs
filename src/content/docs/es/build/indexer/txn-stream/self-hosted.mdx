...
Para hacer eso, primero puedes iniciar tu FN y hacer una sincronización rápida. Luego descarga la base de datos de información de tabla más reciente desde https://console.cloud.google.com/storage/browser/libra2-indexer-grpc-mainnet-table-info-backup (para testnet, reemplaza `mainnet` con `testnet`), descomprime a la carpeta db en tu FN.
