---
title: "Obtener Nombre de Libra2 Desde Dirección"
---
...
`getNameFromAddress` busca un nombre de dominio registrado para una cuenta dada. Por ejemplo, un usuario podría registrar su cuenta con el Servicio de Nombres de Libra2 para estar asociado a `love.apt`. Puedes aprender más yendo a https://www.libra2names.com/.
