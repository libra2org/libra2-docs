...
`getNameFromAddress` busca un nombre de dominio registrado para una cuenta dada. Por ejemplo, un usuario podría registrar su cuenta con el Servicio de Nombres de Libra para estar asociado a `love.apt`. Puedes aprender más yendo a https://www.aptosnames.com/.
