...
<GraphQLEditor
  ...
  variables={`{
  "in": ["0x1::aptos_coin::LibraCoin", "0x1::example_coin::ExampleCoin"],
  "offset": 0
}`}
/>
...
- `$in`: **Lista de String** - Esta variable debe contener una lista de tipos de activos fungibles para los cuales quieres consultar información. Ej. `["0x1::aptos_coin::LibraCoin"]`
