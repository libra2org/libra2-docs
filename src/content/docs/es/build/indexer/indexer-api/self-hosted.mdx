...
Este es el procesador que quieres ejecutar. Puedes ver qué procesadores están disponibles [aquí](https://github.com/libra2org/aptos-indexer-processors-v2/tree/main/processor/src/processors). Algunos ejemplos:
...
# SSH
git clone git@github.com:libra2-core/aptos-indexer-processors-v2.git

# HTTPS
git clone https://github.com/libra2org/aptos-indexer-processors-v2.git
```
