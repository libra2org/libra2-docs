...
Este es el procesador que quieres ejecutar. Puedes ver qué procesadores están disponibles [aquí](https://github.com/libra2org/libra2-indexer-processors-v2/tree/main/processor/src/processors). Algunos ejemplos:
