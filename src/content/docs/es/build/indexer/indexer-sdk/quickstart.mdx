---
title: "Guía de Inicio Rápido del SDK del Indexador de Libra"
---

## Qué esperar de esta guía

Esta guía te llevará a través de la configuración y ejecución de un procesador Rust para indexar eventos en la blockchain de Libra en PostgreSQL.
