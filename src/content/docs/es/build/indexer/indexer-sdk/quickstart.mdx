---
title: "Guía de Inicio Rápido del SDK del Indexador de Libra2"
---

## Qué esperar de esta guía

Esta guía te llevará a través de la configuración y ejecución de un procesador Rust para indexar eventos en la blockchain de Libra2 en PostgreSQL.
...
Para comenzar, clona el repositorio [libra2-indexer-processor-sdk](https://github.com/libra2org/libra2-indexer-processor-sdk).
...
Sigue [esta guía](https://docs.libra2.org/en/build/indexer/txn-stream/libra2-hosted-txn-stream#authorization-via-api-key) para obtener un token del Portal de Desarrolladores. Crea una API Key para `Testnet`, ya que este tutorial es para `Testnet`.
