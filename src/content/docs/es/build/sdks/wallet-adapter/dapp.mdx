...
<Steps>
  1. Instalar @libra2-core/wallet-adapter-react.
     ...
     <details>
       ...
       ### (Opcional) Instalar los plugins para cualquier Wallet "Compatible con Estándar Legacy" que quieras soportar de [esta lista](https://github.com/libra2org/aptos-wallet-adapter/blob/main/README.md#supported-wallet-packages).
...
El [Repositorio del Adaptador de Wallet](https://github.com/libra2org/aptos-wallet-adapter) proporciona varios paquetes de UI para simplificar la posibilidad de que los usuarios se conecten y seleccionen una wallet.

Para componentes de UI que funcionan de forma nativa, pero son menos personalizables, elige uno de:

- [Ant Design](https://github.com/libra2org/aptos-wallet-adapter/tree/main/packages/wallet-adapter-ant-design)
- [MUI](https://github.com/libra2org/aptos-wallet-adapter/tree/main/packages/wallet-adapter-mui-design) (Material UI)

De lo contrario, deberías usar el [selector de wallet de shadcn/ui](https://github.com/libra2org/aptos-wallet-adapter/blob/main/apps/nextjs-example/README.md#use-shadcnui-wallet-selector-for-your-own-app), ya que tiene las opciones de personalización más completas. Para más detalles sobre cómo personalizar este selector de wallet o construir tu propio selector de wallet, consulta [esta guía](https://github.com/libra2org/aptos-wallet-adapter/blob/main/packages/wallet-adapter-react/docs/BYO-wallet-selector.md).

<Aside type="note">
  Para un ejemplo que muestra cómo funcionan estas opciones de UI en la práctica, consulta la [aplicación de demostración en vivo](https://libra2-core.github.io/aptos-wallet-adapter/) (puedes encontrar su código de referencia [aquí](https://github.com/libra2org/aptos-wallet-adapter/tree/main/apps/nextjs-example)).
</Aside>
...
_Ver [`WalletCore.ts`](https://github.com/libra2org/aptos-wallet-adapter/blob/main/packages/wallet-adapter-core/src/WalletCore.ts) en [`wallet-adapter-core`](https://github.com/libra2org/aptos-wallet-adapter/tree/main/packages/wallet-adapter-core) para donde se implementan estas funciones._
...
- [Sitio web en vivo](https://libra2-core.github.io/aptos-wallet-adapter/)
- [Código fuente](https://github.com/libra2org/aptos-wallet-adapter/tree/main/apps/nextjs-example)
