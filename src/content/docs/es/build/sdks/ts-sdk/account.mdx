...
<Aside type="note">
  Siguiendo [AIP-55](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-55.md) el SDK soporta autenticaciones `Legacy` y `Unified`. `Legacy` incluye `ED25519` y `MultiED25519` y `Unified` incluye autenticadores `SingleSender` y `MultiSender`.
</Aside>
