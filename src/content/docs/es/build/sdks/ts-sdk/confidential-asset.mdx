...
const RANGE_PROOF_WASM_URL =
  'https://unpkg.com/@libra2-core/confidential-asset-wasm-bindings@0.3.16/range-proofs/aptos_rp_wasm_bg.wasm'
...
const POLLARD_KANGAROO_WASM_URL =
  'https://unpkg.com/@libra2-core/confidential-asset-wasm-bindings@0.3.15/pollard-kangaroo/aptos_pollard_kangaroo_wasm_bg.wasm'
...
export const aptos = new Libra(config);
```
