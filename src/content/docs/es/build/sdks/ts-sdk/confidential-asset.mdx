...
Puedes usar la propiedad `confidentialCoin` del cliente `Libra2` para interactuar con `CA`
...
Ahora estamos listos para definir el cliente Libra2:

```typescript
const APTOS_NETWORK: Network = NetworkToNetworkName[Network.TESTNET];
const config = new Libra2Config({ network: APTOS_NETWORK });
export const libra2 = new Libra2(config);
```
