...
Para el código fuente completo, consulta el [Ejemplo Multisig V2](https://github.com/libra2org/aptos-ts-sdk/blob/main/examples/typescript-esm/multisig_v2.ts).
