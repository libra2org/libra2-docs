...
Puedes encontrar un ejemplo de cómo escuchar estos eventos [aquí](https://github.com/libra2org/aptos-ts-sdk/blob/main/examples/typescript/batch_funds.ts#L108).
