...
const APTOS_COIN = "0x1::aptos_coin::LibraCoin";
...
3. Buscando datos de la cadena usando funciones de ayuda del cliente como [`aptos.getAccountModules`](https://libra2-core.github.io/aptos-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra.html#getAccountModules).
...
<Aside type="note">
  Para el desarrollo futuro, asegúrate de marcar la [documentación de referencia](https://libra2-core.github.io/aptos-ts-sdk/) para buscar las firmas de funciones específicas.

  Ten en cuenta que la mayoría de las funciones de ayuda están listadas en el objeto [`Libra` cliente](https://libra2-core.github.io/aptos-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra.html).
</Aside>
