...
<Steps>
  ...
  2. Paso 2
     ...
     Con el ABI, puedes usar Surf como una capa sobre el cliente `Libra2` del SDK de TypeScript de Libra2 al interactuar con contratos Move. Para operaciones no relacionadas con contratos, aún deberás usar `Libra2`.
     ...
     // Primero, crea un cliente de Libra2, asegúrate de que la red sea la misma donde vive el contrato
     export const libra2 = new Libra2(new Libra2Config({ network: Network.DEVNET }));
     // Segundo, crea un SurfClient con el cliente de Libra2 y el ABI
