...
<Steps>
  ...
  2. Paso 2
     ...
     Con el ABI, puedes usar Surf como una capa sobre el cliente `Libra` del SDK de TypeScript de Libra al interactuar con contratos Move. Para operaciones no relacionadas con contratos, aún deberás usar `Libra`.
     ...
     // Primero, crea un cliente de Libra, asegúrate de que la red sea la misma donde vive el contrato
     export const libra2 = new Libra(new LibraConfig({ network: Network.DEVNET }));
     // Segundo, crea un SurfClient con el cliente de Libra y el ABI
...
- [Un ejemplo de un launchpad de activo fungible usando Surf](https://github.com/libra2org/move-by-examples/tree/main/fungible-asset-launchpad): Este ejemplo es parte de la guía Solana a Libra en Libra Learn, puedes probarlo [aquí](https://fungible-asset-launchpad.vercel.app/) y leer el tutorial completo [aquí](https://learn.libra2labs.com/en/tutorials/aptogotchi-intermediate/fungible-assets?workshop=solana-to-libra2).

## Créditos

Surf es construido por [Thala Labs](https://thala.fi/), un proyecto del ecosistema Libra, y mantenido junto con la comunidad de Libra.
