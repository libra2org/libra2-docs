...
<Aside type="note">
  Para estos ejemplos, `libra2` es una instancia del objeto cliente [`Libra2`](https://libra2-core.github.io/libra2-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra2.html).
</Aside>
...
<Steps>
  1. Construir
     ...
     2. `gasUnitPrice` - Puedes especificar un precio por gas mayor que el mínimo para ser ejecutado con mayor prioridad por la red de Libra2.
  ...
  2. Simular (Opcional)
     ...
     Cada transacción en la cadena de Libra2 tiene una tarifa de gas asociada con cuánto trabajo tienen que hacer las máquinas de la red al ejecutar la transacción. Para estimar el costo asociado con eso, puedes simular transacciones antes de confirmarlas.
  ...
  5. Esperar
     ...
     Finalmente, puedes esperar el resultado de la transacción usando [`libra2.waitForTransaction`](https://libra2-core.github.io/libra2-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra2.html#waitForTransaction) y especificando el hash de la transacción que acabas de enviar así:
