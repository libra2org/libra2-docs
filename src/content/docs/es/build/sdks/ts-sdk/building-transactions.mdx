...
<Aside type="note">
  Para estos ejemplos, `aptos` es una instancia del objeto cliente [`Libra`](https://libra2-core.github.io/aptos-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra.html).
</Aside>
...
<Steps>
  ...
  5. Esperar
     ...
     Finalmente, puedes esperar el resultado de la transacción usando [`aptos.waitForTransaction`](https://libra2-core.github.io/aptos-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra.html#waitForTransaction) y especificando el hash de la transacción que acabas de enviar así:
