...
<Steps>
  1. Construir
     ...
     2. `GasUnitPrice` - Puedes especificar un precio por gas mayor que el mínimo para ser
        ejecutado con mayor prioridad por la red de Libra.
  ...
  2. Simular (Opcional)
     ...
     Cada transacción en la cadena de Libra tiene una comisión de gas asociada con cuánto
...
4. [Serialización Canónica Binaria (BCS)](/build/sdks/go-sdk/building-transactions/bcs-format) - El formato utilizado para serializar datos para transacciones de Libra.
