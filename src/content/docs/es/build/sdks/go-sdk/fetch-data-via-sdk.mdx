...
Puedes usar el cliente `Libra2` para obtener datos de la cadena usando una variedad de funciones
de ayuda. Específicamente, muchas de las funciones listadas en la [documentación de referencia](https://pkg.go.dev/github.com/libra2org/libra2-go-sdk)
...
El cliente `Libra2` puede por defecto consultar tanto datos de red desde
[fullnodes](https://api.mainnet.libra2labs.com/v1/spec#/) como la
[API del Indexador](https://cloud.hasura.io/public/graphiql?endpoint=https://api.mainnet.libra2labs.com/v1/graphql)
