...
```go filename="sponsor.go"
// sponsored_transaction es un ejemplo de cómo hacer una transacción patrocinada en Libra.
package main
...
func example(networkConfig libra2.NetworkConfig) {
	...
	// Build transaction
	transferPayload, err := libra2.CoinTransferPayload(&libra2.LibraCoinTypeTag, bob.Address, TransferAmount)
	if err != nil {
