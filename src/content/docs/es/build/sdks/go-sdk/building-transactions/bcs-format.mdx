...
Todos los argumentos de transacción para el SDK de Go de Libra están codificados como bytes en formato de
Serialización Canónica Binaria (BCS). Este es el formato que la cadena de Libra
