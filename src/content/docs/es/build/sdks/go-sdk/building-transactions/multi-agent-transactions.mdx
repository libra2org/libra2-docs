...
<Steps>
  1. Construir la transacción incluyendo libra2.AdditionalSigners con una lista de cada firmante adicional.
  ...
  4. Enviar la transacción combinando todas las firmas de agentes a través del parámetro libra2.AdditionalSigners.
...
función `0x1::libra2_account::transfer` - solo espera una dirección, y por eso
