...
Integra capacidades Web3 de Libra2 dentro de tus aplicaciones Unity. El objetivo de este SDK es proporcionar un conjunto de herramientas
para que los desarrolladores construyan juegos Web3 usando el motor de juegos Unity.

**Características Soportadas**

- Soporte para el [SDK de .NET de Libra2](/build/sdks/dotnet-sdk)
...
3. Ingresa la URL del SDK de Unity de Libra2 en este repositorio:
...
Configura tu cliente de Libra2 agregando el namespace `Libra2` e instanciando un `Libra2UnityClient`. Puedes usar una configuración
...
<CardGrid>
  <LinkCard href="https://github.com/libra2org/libra2-unity-starter" title="Libra2 Wallet Starter" description="Proyecto de ejemplo Unity con una integración del SDK de Unity de Libra2." target="_blank" />
</CardGrid>
