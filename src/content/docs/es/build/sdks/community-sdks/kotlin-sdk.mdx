...
Klibra2 es un SDK **Multiplataforma** de Kotlin para interactuar con la blockchain de Libra
...
con lógica de negocio compartida. El SDK incluye clientes **asíncronos** de Libra para
...
<CardGrid>
  <LinkCard href="/es/build/sdks/community-sdks/kotlin-sdk/quickstart" title="Inicio Rápido" description="Integra Libra en < 5 minutos" />
