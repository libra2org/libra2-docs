...
Klibra2 es un SDK **Multiplataforma** de Kotlin para interactuar con la blockchain de Libra2
...
con lógica de negocio compartida. El SDK incluye clientes **asíncronos** de Libra2 para
interacciones suaves con la blockchain.

Klibra2 también proporciona SDKs **específicos de plataforma** para JVM, Android, iOS, JS, Linux,
macOS y Windows.
...
<div className="flex gap-2 mt-6 flex-wrap">
  <img src="https://img.shields.io/maven-central/v/xyz.mcxross.klibra2/klibra2.svg?label=Maven%20Central" alt="Maven Central" />

  <a target="_blank" href="https://mcxross.github.io/klibra2/">
...
- **Expresivo**: Klibra2 proporciona una API simple y expresiva estilo DSL para construir transacciones.
...
<Aside type="note">
  Klibra2 está actualmente en desarrollo, por favor da feedback [aquí](https://github.com/mcxross/klibra2/issues)
</Aside>
...
<Tabs>
  <TabItem label="Multiplataforma">
    ...
    commonMain.dependencies {
      implementation("xyz.mcxross.klibra2:klibra2:<version>")
    }
    ```
  </TabItem>
  ...
  <TabItem label="JVM">
    ...
    jvmMain.dependencies {
      implementation("xyz.mcxross.klibra2:klibra2-jvm:<version>")
    }
    ```
  </TabItem>
  ...
  <TabItem label="Android">
    ...
    androidMain.dependencies {
      implementation("xyz.mcxross.klibra2:klibra2-android:<version>")
    }
    ```
    ...
    <Aside type="note" emoji="ℹ️">
      ...
      ```kotlin
      androidMain.dependencies {
        implementation("xyz.mcxross.klibra2:klibra2-android-debug:<version>")
      }
      ```
    </Aside>
  </TabItem>
  ...
  <TabItem label="iOS">
    ...
    iosMain.dependencies {
      implementation("xyz.mcxross.klibra2:klibra2-iosArm64:<version>")
    }
    ```
    ...
    ```kotlin
    iosMain.dependencies {
      implementation("xyz.mcxross.klibra2:klibra2-iosX64:<version>")
    }
    ```
  </TabItem>
  ...
  <TabItem label="JS">
    ```kotlin
    jsMain.dependencies {
      implementation("xyz.mcxross.klibra2:klibra2-js:<version>")
    }
    ```
  </TabItem>
  ...
  <TabItem label="Linux">
    ...
    linuxMain.dependencies {
      implementation("xyz.mcxross.klibra2:klibra2-linux:<version>")
    }
    ```
  </TabItem>
  ...
  <TabItem label="macOS">
    ...
    macosMain.dependencies {
      implementation("xyz.mcxross.klibra2:klibra2-macosX64:<version>")
    }
    ```
    ...
    ```kotlin
    macosMain.dependencies {
      implementation("xyz.mcxross.klibra2:klibra2-macosArm64:<version>")
    }
    ```
  </TabItem>
  ...
  <TabItem label="Windows">
    ...
    mingwMain.dependencies {
      implementation("xyz.mcxross.klibra2:klibra2-mingwX64:<version>")
    }
    ```
  </TabItem>
</Tabs>
...
<RemoteCodeblock permalink="https://github.com/mcxross/klibra2/blob/64731d7085bfa64e93941aad78ba5ac429787552/sample/jvmApp/src/main/kotlin/APTTransfer.kt#L59-L71" />
...
```kotlin
val txn = libra2.transferCoinTransaction(
...
<CardGrid>
  <LinkCard href="/es/build/sdks/community-sdks/kotlin-sdk/quickstart" title="Inicio Rápido" description="Integra Libra2 en < 5 minutos" />

  <LinkCard href="https://github.com/mcxross/klibra2/tree/master/sample" title="Proyectos Únicos y Multiplataforma" description="Explora varias apps demo, proyectos únicos y multiplataforma, sobre cómo usar el SDK" target="_blank" />
</CardGrid>
