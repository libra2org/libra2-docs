...
Esta API - integrada en Nodos Completos - proporciona una forma simple, de baja latencia, pero de bajo nivel de leer estado y enviar transacciones a la Blockchain de Libra2. También soporta simulación de transacciones.
...
Como con el [Indexador de Libra2](/build/indexer/indexer-api), la API REST de Libra2 tiene límites de tasa basados en unidades de cómputo. Puedes aprender más sobre cómo funciona el límite de tasa leyendo la [documentación de Libra2 Build](https://build.libra2labs.com/docs/start/billing).

## Viendo estado actual e histórico

La mayoría de las integraciones en la blockchain de Libra2 se benefician de una visión holística y comprensiva del estado actual e
histórico de la blockchain. Libra2 proporciona transacciones históricas, estado y eventos, todo el resultado de
...
a `false` en `storage_config.rs`. Este es el comportamiento por defecto en Mainnet. En el futuro cercano, Libra2 proporcionará indexadores
...
La función view opera como la API de simulación de Libra2,
...
a través de la [CLI de Libra2](/build/cli).

En la CLI de Libra2, una solicitud de función view se vería así:
...
import { Libra2 } from "@libra2-core/ts-sdk";
