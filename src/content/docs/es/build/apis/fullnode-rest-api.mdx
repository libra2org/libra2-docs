...
Como con el [Indexador de Libra](/build/indexer/indexer-api), la API REST de Libra tiene límites de tasa basados en unidades de cómputo. Puedes aprender más sobre cómo funciona el límite de tasa leyendo la [documentación de Libra Build](https://build.aptoslabs.com/docs/start/billing).
...
- código [Move](https://github.com/libra2org/libra2-core/blob/90c33dc7a18662839cd50f3b70baece0e2dbfc71/aptos-move/framework/aptos-framework/sources/coin.move#L226) relacionado
