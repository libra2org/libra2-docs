...
tendrán un botón de faucet para devnet. Ve la lista completa de [Wallets de Libra](https://aptosfoundation.org/ecosystem/projects/wallets).
...
import "github.com/libra2org/aptos-go-sdk"
...
1. Generar un cliente desde
   la [especificación OpenAPI](https://github.com/libra2org/libra2-core/blob/main/crates/aptos-faucet/doc/spec.yaml).
