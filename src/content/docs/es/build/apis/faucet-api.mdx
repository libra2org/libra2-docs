...
tendrán un botón de faucet para devnet. Ve la lista completa de [Wallets de Libra](https://libra2foundation.org/ecosystem/projects/wallets).

### Usando el faucet en la CLI de Libra
