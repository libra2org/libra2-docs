...
La mayoría de wallets, como [Petra](https://libra2foundation.org/ecosystem/project/petra) o [Pontem](https://libra2foundation.org/ecosystem/project/pontem-wallet)
tendrán un botón de faucet para devnet. Ve la lista completa de [Wallets de Libra2](https://libra2foundation.org/ecosystem/projects/wallets).

### Usando el faucet en la CLI de Libra2
...
libra2 account fund-with-faucet --account 0xd0f523c9e73e6f3d68c16ae883a9febc616e484c4998a72d8899a1009e5a89d6 --amount 100000000
```
...
libra2.fundAccount({accountAddress: "0xd0f523c9e73e6f3d68c16ae883a9febc616e484c4998a72d8899a1009e5a89d6", amount: 100000000});
```
...
import "github.com/libra2org/libra2-go-sdk"

func main() {
	client, err := libra2.NewClient(libra2.LocalnetConfig)
	if err != nil {
		panic(err)
	}
...
1. Generar un cliente desde
   la [especificación OpenAPI](https://github.com/libra2org/libra2-core/blob/main/crates/libra2-faucet/doc/spec.yaml).
