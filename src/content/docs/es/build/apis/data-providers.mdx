...
Dado que la lógica para analizar transacciones es [pública](https://github.com/libra2org/aptos-indexer-processors-v2), algunos proveedores han implementado lógica de análisis similar para crear un subconjunto de tablas y las han hecho disponibles para consulta.
