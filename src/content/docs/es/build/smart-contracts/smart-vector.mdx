...
- [smart\_vector.move](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-stdlib/sources/data_structures/smart_vector.move)
