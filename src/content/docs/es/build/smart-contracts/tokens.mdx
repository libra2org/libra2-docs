---
title: "Resumen del Estándar de Token de Libra2"
---

El [Estándar de Activo Digital de Libra2](/build/smart-contracts/digital-asset) define el
Token No Fungible canónico en Libra2. Libra2 aprovecha la composabilidad para extender
...
El resto de este documento discute cómo los estándares de token de Libra2 se comparan con los
...
A diferencia de Ethereum o Libra2 donde los datos y código coexisten, Solana almacena datos y
...
Las [cuentas](/network/blockchain/accounts) en Libra2 almacenan tanto contratos inteligentes
...
Hay dos medios para crear NFTs en Libra2:

- El [estándar sin código](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-22.md)
...
Libra2 logra un balance entre la personalización ofrecida por Ethereum con la
simplicidad de crear nuevas colecciones como Solana.

Como Ethereum, Libra2 requiere indexación para determinar el conjunto de todos los NFTs poseídos por
...
La colección de estándares de token de Libra2 comparte algunas similitudes con Solana,
...
Libra2 identifica un token por su `Address` o `ObjectId`, una ubicación dentro del
...
El token de Libra2 tiene metadatos en su recurso `Token` con los datos más comúnmente
...
que está definido en `TokenDataId` en Libra2. Solana, sin embargo, no ofrece
mutabilidad para activos, a diferencia de Libra2. Como Libra2, Metadatos de Token v1.1.0 ofrece
