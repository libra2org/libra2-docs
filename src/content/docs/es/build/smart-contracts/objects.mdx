...
module my_addr::object_playground {
  ...
  use libra2_framework::object::{Self, ObjectCore};
...
- [Ejemplo de Mercado de Activos Digitales](https://github.com/libra2org/libra2-core/tree/main/libra2-move/move-examples/marketplace)
- [Ejemplos de Activos Digitales](https://github.com/libra2org/libra2-core/tree/main/libra2-move/move-examples/token_objects)
- [Ejemplos de Activos Fungibles](https://github.com/libra2org/libra2-core/tree/main/libra2-move/move-examples/fungible_asset)
