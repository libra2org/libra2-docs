...
La criptografía juega un papel integral en garantizar la seguridad, integridad, confidencialidad e inmutabilidad de los datos en los sistemas blockchain. El adaptador de Libra para Move proporciona a los desarrolladores una variedad de primitivas criptográficas para satisfacer esta necesidad. Este documento profundiza en las funcionalidades criptográficas ofrecidas por Move en Libra y explica los principios que impulsan su diseño.

## Primitivas criptográficas

Move, a través del adaptador de Libra, abarca varias herramientas criptográficas fundamentales:
...
Tres principios fundamentales guían el diseño e integración de las extensiones criptográficas de Libra en Move:
...
Normalmente, los desarrolladores de tales aplicaciones tendrían que esperar hasta que su funcionalidad criptográfica deseada se implemente eficientemente como una [función nativa de Move](/build/smart-contracts/book/functions#native-functions) en el [marco de Move de Libra](/network/blockchain/move).
