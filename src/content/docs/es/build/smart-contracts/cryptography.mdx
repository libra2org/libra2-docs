...
1. **Uso Económico de Gas** – Se busca minimizar los costos de gas para los desarrolladores de Move implementando primitivas clave como [funciones nativas de Move](/build/smart-contracts/book/functions#native-functions). Por ejemplo, consulta el módulo para [firmas BLS sobre curvas elípticas BLS12-381](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/bls12381.move).
2. **APIs Seguras por Tipo** – Asegurando que las APIs sean resistentes a errores comunes, la seguridad de tipos mejora la confiabilidad del código y promueve un proceso de desarrollo eficiente. Por ejemplo, consulta el [módulo de firmas Ed25519](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/ed25519.move).
3. **Empoderamiento de Desarrolladores** – En casos donde no hay funciones nativas disponibles, empoderamos a los desarrolladores para construir sus propias primitivas criptográficas sobre bloques abstractos como _campos finitos_ y _grupos abelianos_. Consulta el módulo [`aptos_std::crypto_algebra`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/crypto_algebra.move) para más información.
...
Los desarrolladores ahora pueden usar más funciones hash criptográficas en Move a través del módulo [`aptos_std::aptos_hash`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/hash.move):
...
Algunas de estas funciones pueden usarse para interoperabilidad con otras cadenas (por ejemplo, verificar pruebas de Merkle de Ethereum vía [`aptos_std::aptos_hash::keccak256`](https://github.com/libra2org/libra2-core/blob/137acee4c6dddb1c86398dce25b041d78a3028d3/aptos-move/framework/aptos-stdlib/sources/hash.move#L35)).
Otras, tienen menores costos de gas, como [`aptos_std::aptos_hash::blake2b_256`](https://github.com/libra2org/libra2-core/blob/137acee4c6dddb1c86398dce25b041d78a3028d3/aptos-move/framework/aptos-stdlib/sources/hash.move#L69).
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ----------------- | --------------- | ------------ | ----------- | ------------- | ------------------- |
| [ECDSA](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/secp256k1.move)                          | secp256k1     | 64                | 64              | Sí          | GGM         | Adopción amplia | Prueba de seguridad      |
| [Ed25519](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/ed25519.move)                          | Edwards 25519 | 64                | 32              | No           | DLA, ROM    | Rápido          | Subtleties          |
| [MultiEd25519](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/multi_ed25519.move)               | Edwards 25519 | $4 + t \cdot 64$  | $n \cdot 32$    | No           | DLA, ROM    | Fácil de adoptar | Tamaño de firma grande     |
| [MinPK BLS](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/bls12381.move)                       | BLS12-381     | 96                | 48              | No           | CDH, ROM    | Versátil     | Verificación más lenta |
| [MinSig BLS](https://github.com/libra2org/libra2-core/blob/7d4fb98c6604c67e526a96f55668e7add7aaebf6/aptos-move/move-examples/drand/sources/drand.move#L57) | BLS12-381     | 48                | 96              | No           | CDH, ROM    | Versátil     | Verificación más lenta |
...
1. Ristretto255, a través de [`aptos_std::ristretto255`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/ristretto255.move)
2. BLS12-381, a través de [`aptos_std::crypto_algebra`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/crypto_algebra.move)
   y [`aptos_std::bls12381_algebra`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/bls12381_algebra.move)
...
El módulo [`aptos_std::ristretto255`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/ristretto255.move) proporciona soporte para la aritmética de curvas elípticas en la popular [curva Ristretto255](https://ristretto.group/).
...
2. **Cifrado ElGamal** – Consulta [`aptos_std::ristretto255_elgamal`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/ristretto255_elgamal.move)
3. **Comités de Pedersen** – Consulta [`aptos_std::ristretto255_pedersen`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/ristretto255_pedersen.move)
4. **Pruebas de rango ZK Bulletproofs\[^bulletproofs]** – Consulta [`aptos_std::ristretto255_bulletproofs`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/ristretto255_bulletproofs.move)
...
El módulo [`aptos_std::crypto_algebra`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/crypto_algebra.move) proporciona operaciones de aritmética de curva elíptica para **cualquier** curva elíptica soportada, incluyendo curvas de emparejamiento.
...
Aunque actualmente el módulo `crypto_algebra` solo soporta aritmética sobre curvas BLS12-381 (a través de los tipos marcadores declarados en [`aptos_std::bls12381_algebra`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-stdlib/sources/cryptography/bls12381_algebra.move)), más curvas serán soportadas en el futuro (por ejemplo, BN254, Ristretto255, BLS12-377, BW6-761, secp256k1, secp256r1).
...
El ejemplo de [`groth16`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/move-examples/groth16_example/sources/groth16.move) demuestra cómo verificar pruebas de Groth16 zkSNARK\[^groth16], que son las pruebas de conocimiento cero más cortas, rápidas de verificar y de propósito general.
...
El ejemplo de [`drand`](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/drand/sources) muestra cómo verificar aleatoriedad pública desde el [beacon de aleatoriedad de drand](https://drand.love).
Esta aleatoriedad puede usarse en juegos o cualquier otro contrato inteligente basado en azar.
Damos un ejemplo simple de una lotería implementada sobre la aleatoriedad de `drand` en [`lottery.move`](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/drand/sources/lottery.move).
