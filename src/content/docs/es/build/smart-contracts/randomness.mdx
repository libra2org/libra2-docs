...
La lista completa de funciones de API y documentación puede encontrarse [aquí](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/doc/randomness.md).
...
También puedes encontrar la implementación parcial de las funciones de API y ejemplos de pruebas unitarias [aquí](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/randomness.move).
