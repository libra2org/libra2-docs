...
Un [NFT](https://en.wikipedia.org/wiki/Non-fungible_token) es un [token](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token/sources/token.move) no fungible o datos almacenados en una blockchain que
...
El [estándar de token de Libra](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token/sources/token.move) se desarrolla con los siguientes principios:
...
El estándar de token de Libra usa el módulo [`PropertyMap`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token/sources/property_map.move) para almacenar propiedades
...
String) son soportados en `PropertyMap`. Aplicaciones, como [Libra Names](https://www.aptosnames.com/),
...
Puedes agregar tus propiedades a [`default_properties`](https://github.com/libra2org/libra2-core/blob/e62fd09cb1c916d857fa655b3f174991ef8698b3/aptos-move/framework/aptos-token/sources/token.move#L98) en TokenData. Las
...
- Cuando los creadores mutan las propiedades por defecto de un token, el token mutado
  será asignado un `property_version` único para crear un nuevo [`token_id`](https://github.com/libra2org/libra2-core/blob/bba1690d7268759bd86ccd7459d7967172f1da24/aptos-move/framework/aptos-token/sources/token.move#L288)
...
proporciona [`mutability_config`](https://github.com/libra2org/libra2-core/blob/bba1690d7268759bd86ccd7459d7967172f1da24/aptos-move/framework/aptos-token/sources/token.move#L100)
