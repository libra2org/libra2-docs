---
title: "Estándar de Token de Libra2 (Legacy)"
---
...
Un [NFT](https://en.wikipedia.org/wiki/Non-fungible_token) es un [token](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-token/sources/token.move) no fungible o datos almacenados en una blockchain que
...
El [estándar de token de Libra2](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-token/sources/token.move) se desarrolla con los siguientes principios:
...
<Aside type="note">
  **Token fungible → NFT**<br />
  El estándar de token de Libra2 soporta [mutación de un token fungible a un
  NFT](#evolucionando-desde-token-fungible-a-nft).
</Aside>

### Almacenar propiedades de token personalizadas en cadena

El estándar de token de Libra2 usa el módulo [`PropertyMap`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-token/sources/property_map.move) para almacenar propiedades
...
String) son soportados en `PropertyMap`. Aplicaciones, como [Libra2 Names](https://www.libra2names.com/),
...
Puedes agregar tus propiedades a [`default_properties`](https://github.com/libra2org/libra2-core/blob/e62fd09cb1c916d857fa655b3f174991ef8698b3/libra2-move/framework/libra2-token/sources/token.move#L98) en TokenData. Las
...
tal evolución de propiedades de token, el estándar de token de Libra2 proporciona el
...
- Cuando los creadores mutan las propiedades por defecto de un token, el token mutado
  será asignado un `property_version` único para crear un nuevo [`token_id`](https://github.com/libra2org/libra2-core/blob/bba1690d7268759bd86ccd7459d7967172f1da24/libra2-move/framework/libra2-token/sources/token.move#L288)
...
Para hacer la mutabilidad explícita tanto para el creador como para el propietario, el estándar de token de Libra2
proporciona [`mutability_config`](https://github.com/libra2org/libra2-core/blob/bba1690d7268759bd86ccd7459d7967172f1da24/libra2-move/framework/libra2-token/sources/token.move#L100)
