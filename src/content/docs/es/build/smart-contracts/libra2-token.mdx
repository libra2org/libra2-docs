---
title: "Estándar de Token de Libra (Legacy)"
---
...
El [estándar de token de Libra](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-token/sources/token.move) se desarrolla con los siguientes principios:
...
<Aside type="note">
  **Token fungible → NFT**<br />
  El estándar de token de Libra soporta [mutación de un token fungible a un
  NFT](#evolucionando-desde-token-fungible-a-nft).
</Aside>

### Almacenar propiedades de token personalizadas en cadena

El estándar de token de Libra usa el módulo [`PropertyMap`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-token/sources/property_map.move) para almacenar propiedades
...
String) son soportados en `PropertyMap`. Aplicaciones, como [Libra Names](https://www.libra2names.com/),
...
tal evolución de propiedades de token, el estándar de token de Libra proporciona el
...
Para hacer la mutabilidad explícita tanto para el creador como para el propietario, el estándar de token de Libra
