---
title: "Libra Move Lint"
---

La herramienta "Libra Move Lint" se ejecuta en un paquete Move para encontrar y advertir sobre problemas comunes en programas Move, ayudando a mejorar tu código Move.
