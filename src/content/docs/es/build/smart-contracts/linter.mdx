---
title: "Libra2 Move Lint"
---

La herramienta "Libra2 Move Lint" se ejecuta en un paquete Move para encontrar y advertir sobre problemas comunes en programas Move, ayudando a mejorar tu código Move.

Puedes ejecutarla con el comando de la CLI de libra2: `libra2 move lint`.

Si encuentras algún problema, por favor envía [bugs y retroalimentación](https://github.com/libra2org/libra2-core/issues/new?title=%5Blinter%5D%20%3CDescriptive%20Title%3E\&body=%3CDetailed%20description%20of%20the%20issue%20or%20feature%20request%3E\&labels=move-linter\&projects=libra2-core/16). También, estamos rastreando ideas y solicitudes de priorización para nuevas reglas de lint [aquí](https://github.com/libra2org/libra2-core/issues/15221), damos la bienvenida a tus contribuciones.
