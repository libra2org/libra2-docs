...
## Consideraciones de rendimiento y costo de gas de la Blockchain de Libra2

El estado de la Blockchain de Libra2 se mantiene en **slots de almacenamiento**.
...
module 0x42::map_usage {
    use libra2_framework::ordered_map;
...
- [ordered\_map.move](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/sources/datastructures/ordered_map.move)
- [table.move](https://github.com/libra2org/libra2-core/blob/6f5872b567075fe3615e1363d35f89dc5eb45b0d/libra2-move/framework/libra2-stdlib/sources/table.move)
- [table\_with\_length.move](https://github.com/libra2org/libra2-core/blob/6f5872b567075fe3615e1363d35f89dc5eb45b0d/libra2-move/framework/libra2-stdlib/sources/table.move)
- [big\_ordered\_map.move](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/sources/datastructures/big_ordered_map.move)
