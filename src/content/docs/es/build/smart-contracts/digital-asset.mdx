...
Este estándar reemplaza el legado [Estándar de Token de Libra](/build/smart-contracts/aptos-token). Las mejoras más importantes a notar son:
...
<Aside type="caution">
  Changing the royalty requires generating a _separate_ `MutatorRef` from the [Royalty module](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/royalty.move).
</Aside>
...
- [Digital Asset Examples](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/token_objects)
- [Digital Asset Marketplace Example](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/marketplace)
- [Source code](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/token.move)
- [`aptos_token` source code](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/aptos_token.move)
