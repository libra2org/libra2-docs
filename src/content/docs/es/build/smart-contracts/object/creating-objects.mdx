...
Puedes encontrar documentación para todos los posibles `Refs` mirando la documentación de referencia de Move para `0x1::object` [aquí](/es/move-reference/mainnet/libra2-framework/object).
