...
[Despliegue de Código de Objeto](/build/smart-contracts/deployment) es el método preferido para desplegar y actualizar contratos inteligentes en Libra. Las cuentas de recurso requieren que los desarrolladores generen semillas
...
En Libra, una cuenta de recurso se crea basándose en el hash SHA3-256 de la
...
la creación de una cuenta de recurso. Pero si se encuentra una cuenta de recurso, Libra
...
1. Usando Libra CLI: `libra2 account create-resource-account` crea una cuenta de
