...
<Aside type="note">
  Recomendamos instalar la CLI de Libra2 antes de comenzar.
  Si aún no has instalado la CLI de Libra2, consulta la [sección CLI](/build/cli)
</Aside>
...
<Steps>
  1. libra2 move init
     ...
     libra2 move init --name <NOMBRE_DEL_PROYECTO>
     ```
  ...
  2. Actualizar Move.toml
     ...
     4. `dependencies`: Probablemente querrás usar `Libra2Framework` y otras [Dependencias de Terceros](/build/smart-contracts/third-party-dependencies)
  ...
  3. Agregar al directorio sources
     ...
     <RemoteCodeblock permalink="https://github.com/libra2org/libra2-core/blob/afd3706c17bcccfb39a9d6059aecbfa648ed295d/libra2-move/move-examples/hello_blockchain/sources/hello_blockchain.move#L1-L64" />
</Steps>
