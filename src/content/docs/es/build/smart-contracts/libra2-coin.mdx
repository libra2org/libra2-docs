...
[Coin](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/sources/coin.move)
...
consulta el [Framework de Libra](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/doc/overview.md)
que contiene [`coin`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-framework/doc/coin.md).

##### [`Coin`](https://github.com/libra2org/libra2-core/blob/744c2def47cddced878fda9bbd5633022fdb083a/aptos-move/framework/aptos-framework/sources/coin.move#L68)

| Campo   | Tipo | Descripción                        |
| ------- | ---- | ---------------------------------- |
| `value` | u64  | Valor del token, por ejemplo: 1000000000 |

##### [`CoinInfo`](https://github.com/libra2org/libra2-core/blob/744c2def47cddced878fda9bbd5633022fdb083a/aptos-move/framework/aptos-framework/sources/coin.move#L92)
