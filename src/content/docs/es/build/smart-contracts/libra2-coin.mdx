---
title: "Estándar de Moneda de Libra2 (Legacy)"
---

import { Aside } from '@astrojs/starlight/components';

[Coin](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/sources/coin.move)
...
consulta el [Framework de Libra2](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/doc/overview.md)
que contiene [`coin`](https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/doc/coin.md).

##### [`Coin`](https://github.com/libra2org/libra2-core/blob/744c2def47cddced878fda9bbd5633022fdb083a/libra2-move/framework/libra2-framework/sources/coin.move#L68)

| Campo   | Tipo | Descripción                        |
| ------- | ---- | ---------------------------------- |
| `value` | u64  | Valor del token, por ejemplo: 1000000000 |

##### [`CoinInfo`](https://github.com/libra2org/libra2-core/blob/744c2def47cddced878fda9bbd5633022fdb083a/libra2-move/framework/libra2-framework/sources/coin.move#L92)

| Campo      | Tipo                             | Descripción                                                                                                                      |
| ---------- | -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `name`     | String                           | Nombre del token, por ejemplo: Moneda de Libra2                                                                                                |
