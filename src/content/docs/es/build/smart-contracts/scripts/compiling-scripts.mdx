...
Los scripts de Move pueden ser compilados con el compilador de Move de Libra2 ya existente en
la CLI de Libra2. Para más información sobre cómo instalar y usar la CLI de Libra2 con contratos de Move, ve a la página [Trabajando con Contratos de Move](/build/cli/working-with-move-contracts).

Una vez que tengas la CLI de Libra2 instalada, puedes compilar un script ejecutando el siguiente comando desde dentro del paquete del script:
