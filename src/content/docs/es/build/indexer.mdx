...
Tenemos varias ofertas para obtener datos indexados de la blockchain de Libra2.
...
El Indexador de Libra2 es una API que puedes usar para obtener:

1. Datos agregados (ej. ¿Cuántos NFTs existen?)
2. Datos históricos (ej. ¿Qué transacciones ha enviado esta cuenta?)
3. Datos que son difíciles de obtener desde la API más simple del [Nodo de Libra2](/build/apis/fullnode-rest-api) (ej. ¿Qué cuenta posee un token llamado "ExampleToken"?).
...
<CardGrid>
  ...
  <LinkCard href="/es/build/indexer/indexer-api/ans-lookup" title="Obtener Nombre de Libra2" description="Recupera el nombre de Libra2 asociado con una cuenta (a través del ANS)." />
...
<CardGrid>
  <LinkCard href="/es/build/indexer/txn-stream/libra2-hosted-txn-stream" title="Servicio de Transmisión de Transacciones Hospedado por Libra2" description="Obtén acceso al Servicio de Transmisión de Transacciones hospedado por Libra2" />
</CardGrid>
