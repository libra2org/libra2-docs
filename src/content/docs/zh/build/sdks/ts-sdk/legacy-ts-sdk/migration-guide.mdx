...
TypeScript SDK V2 已迁移至新的 [GitHub 仓库](https://github.com/libra2org/aptos-ts-sdk),并使用新的包名 - `@libra2-core/ts-sdk`
...
```typescript filename="v2.ts"
const aptosConfig = new LibraConfig({ network: Network.DEVNET }); // 默认为 devnet
