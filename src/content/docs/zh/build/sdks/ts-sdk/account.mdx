...
<Aside type="note">
  根据 [AIP-55](https://github.com/libra2-foundation/AIPs/blob/main/aips/aip-55.md),SDK 支持 `Legacy` 和 `Unified` 认证方式.`Legacy` 包含 `ED25519` 和 `MultiED25519`,而 `Unified` 包含 `SingleSender` 和 `MultiSender` 认证器.
</Aside>
