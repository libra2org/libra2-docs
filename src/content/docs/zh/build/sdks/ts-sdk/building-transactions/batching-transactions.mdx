...
可以通过 `libra2.transaction.batch.forSingleAccount` 实现,如下例所示.

## 完整 TypeScript 示例

```typescript filename="batch.ts"
/**
 * 此示例展示如何使用 Libra2 SDK 批量发送多个交易
 */
...
监听这些事件的示例可参考[此处](https://github.com/libra2org/libra2-ts-sdk/blob/main/examples/typescript/batch_funds.ts#L108).
