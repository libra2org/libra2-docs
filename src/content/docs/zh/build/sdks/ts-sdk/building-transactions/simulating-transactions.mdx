...
在 `libra2.transaction.simulate.simple` 方法中,`signerPublicKey` 参数用于在交易模拟期间验证签名者的认证密钥.该参数是可选的,如果省略,模拟将跳过认证密钥检查.例如:
...
完整源代码...要查看完整代码,请参考 [Multisig V2 示例](https://github.com/libra2org/libra2-ts-sdk/blob/main/examples/typescript-esm/multisig_v2.ts).
