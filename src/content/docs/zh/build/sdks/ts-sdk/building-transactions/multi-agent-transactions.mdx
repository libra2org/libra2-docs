...
2. 更新下方代码片段以构建需要多代理签名的交易
   ...
   2. 此自定义是必要的,因为 Libra 没有预制的需要多代理签名的合约.如果您想部署自己的示例多代理合约,可以部署 ["transfer two by two" 示例 Move 合约](https://github.com/libra2org/aptos-ts-sdk/blob/main/tests/move/transfer/sources/script_two_by_two.move#L5)
