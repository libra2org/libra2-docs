...
1. 使用 `Libra` 客户端连接网络
2. 创建账户
3. 使用客户端辅助函数如 [`aptos.getAccountModules`](https://libra2-core.github.io/aptos-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra.html#getAccountModules) 查询链上数据
4. 签名并向网络提交交易
5. 等待 Libra 执行交易
...
<Aside type="note">
  为了后续开发,请务必收藏 [参考文档](https://libra2-core.github.io/aptos-ts-sdk/) 以便查阅具体函数签名.

  请注意,大多数辅助函数都列在 [`Libra` 客户端对象](https://libra2-core.github.io/aptos-ts-sdk/@libra2-core/ts-sdk-1.35.0/classes/Libra.html)上.
</Aside>
