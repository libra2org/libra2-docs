...
<Steps>
  ...
  4. 在新终端中运行以下命令来启动私有网络:
     ...
     已完成生成配置：
             ...
             Libra 根密钥路径："/Users/dport/.aptos/testnet/mint.key"
...
然后你可以在以后使用该配置文件执行任何命令.例如,如果你想将 [`hello_blockchain`](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/hello_blockchain) 包发布到你的本地网络,你可以运行:

```shellscript filename="Terminal"
aptos move publish --profile <你的配置文件名称> --package-dir /opt/git/libra2-core/aptos-move/move-examples/hello_blockchain --named-addresses HelloBlockchain=local
```
