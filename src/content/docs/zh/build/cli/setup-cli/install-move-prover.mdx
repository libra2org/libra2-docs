...
安装后,您可以运行 Move Prover 来验证一个[示例](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/hello_prover):
...
如果在运行命令时遇到如下错误,请检查您的 Libra CLI 版本或验证您使用的是正确的 `aptos` 工具,特别是如果您安装了多个版本.
