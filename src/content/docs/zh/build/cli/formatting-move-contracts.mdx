...
`movefmt` 是一个格式化工具,可以让 Move 代码更容易编写,阅读和维护 — 极大地改善了 Libra2 上的开发体验.

## 安装

`movefmt` 已集成到 Libra2 CLI 中.要开始使用它,首先使用 CLI 更新命令安装它.
...
Libra2 Labs 始终致力于改善使用 Move 在 Libra2 上构建的开发者体验.
