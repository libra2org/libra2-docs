...
`movefmt` 是一个格式化工具,可以让 Move 代码更容易编写,阅读和维护 — 极大地改善了 Libra 上的开发体验.

## 安装

`movefmt` 已集成到 Libra CLI 中.要开始使用它,首先使用 CLI 更新命令安装它.
...
Libra Labs 始终致力于改善使用 Move 在 Libra 上构建的开发者体验.
