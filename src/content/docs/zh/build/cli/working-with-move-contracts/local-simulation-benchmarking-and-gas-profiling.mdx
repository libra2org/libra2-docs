...
为了演示目的,我们将继续使用[`hello_blockchain`](https://github.com/libra2org/libra2-core/tree/main/libra2-move/move-examples/hello_blockchain) 包作为示例.
...
Libra2 Gas 剖析器是一款强力工具,能助您深入理解 Libra2 交易中的 Gas 消耗情况.一旦启用,它会利用一个增强了监测功能的虚拟机来模拟交易,并生成一份基于网页的报告.
