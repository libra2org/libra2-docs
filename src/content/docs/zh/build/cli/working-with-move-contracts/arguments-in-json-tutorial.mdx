...
本节引用 [`CliArgs` 示例包](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/cli_args),其包含以下清单:
...
<Aside type="note" emoji="ℹ️">
  将你的工作目录设置为 [`aptos-move/move-examples/cli_args`](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/cli_args) 以便跟随:
