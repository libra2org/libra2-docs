...
另外,如果您想要模拟一个新的交易,请查看[本地模拟,基准测试和 Gas 分析](/zh/build/cli/working-with-move-contracts/local-simulation-benchmarking-and-gas-profiling).
...
您可以在目录 gas-profiling 中找到[生成的 Gas 报告](/zh/gas-profiling/sample-report-2/index.html):
...
要理解 Gas 报告,请参考[本地模拟教程](/zh/build/cli/working-with-move-contracts/local-simulation-benchmarking-and-gas-profiling.mdx#understanding-the-gas-report)的这一部分.
