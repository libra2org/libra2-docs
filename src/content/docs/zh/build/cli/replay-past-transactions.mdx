...
你可以使用 `libra2 move replay` 命令在本地重放过去的交易.
...
让我们以主网交易 [581400718](https://explorer.libra2labs.com/txn/581400718?network=mainnet)(一个简单的代币转账交易)为例.
...
Libra2 气体分析器是一个强大的工具,可以帮助你了解 Libra2 交易的气体使用情况.一旦激活,它将使用仪器化的虚拟机模拟交易,并生成基于 Web 的报告.
...
<details>
  ...
  从 RestApi 获取了 1/1 个交易。
  正在分析交易...
  气体报告已保存到 gas-profiling/txn-1ba73d03-0x1-libra2_account-transfer。
  {
    "Result": {
      "transaction_hash": "0x1ba73d03a0442a845735a17c7be46f3b51e2acb0e5cf68749305c5a17539ac63",
      "gas_used": 7,
