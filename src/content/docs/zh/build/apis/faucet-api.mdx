...
1. 从 [OpenAPI 规范](https://github.com/libra2org/libra2-core/blob/main/crates/aptos-faucet/doc/spec.yaml)生成客户端.
2. 自行调用水龙头.
...
[@libra2-core/aptos-faucet-client](https://www.npmjs.com/package/@libra2-core/aptos-faucet-client)
...
import {
  LibraFaucetClient,
  FundRequest,
} from "@libra2-core/aptos-faucet-client";
