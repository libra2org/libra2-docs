...
与 [Libra 索引器](/zh/build/indexer/indexer-api) 类似,Libra REST API 也基于计算单元设有速率限制.您可以通过阅读 [Libra Build 文档](https://build.aptoslabs.com/docs/start/billing) 了解更多关于速率限制的工作原理.
...
- 相关 [Move](https://github.com/libra2org/libra2-core/blob/90c33dc7a18662839cd50f3b70baece0e2dbfc71/aptos-move/framework/aptos-framework/sources/coin.move#L226) 代码
