...
<CardGrid>
  <LinkCard href="/zh/build/apis/fullnode-rest-api-reference?network=mainnet" title="Aptos Fullnode REST API（主网）" description="Aptos Fullnode REST API 的主网 API playground" />

  <LinkCard href="/zh/build/apis/fullnode-rest-api-reference?network=testnet" title="Aptos Fullnode REST API（测试网）" description="Aptos Fullnode REST API 的测试网 API playground" />

  <LinkCard href="/zh/build/apis/fullnode-rest-api-reference?network=devnet" title="Aptos Fullnode REST API（开发网）" description="Aptos Fullnode REST API 的开发网 API playground" />
</CardGrid>
