...
Libra 允许在 [package](/zh/build/smart-contracts/book/packages) 中无权限地发布 [module](/zh/build/smart-contracts/book/modules-and-scripts),并且对于设置了合适兼容性策略的模块支持 [升级](/zh/build/smart-contracts/book/package-upgrades).
