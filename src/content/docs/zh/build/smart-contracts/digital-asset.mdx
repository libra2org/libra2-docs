...
该标准取代了旧的 [Libra Token Standard](/zh/build/smart-contracts/aptos-token).主要改进如下:
...
| **Royalty**     | 可选 [`Royalty`](/zh/move-reference/mainnet/aptos-token-objects/royalty#Royalty) 结构体,表示销售价格中归创作者的分成比例.可通过 [Royalty 模块](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/royalty.move) 生成的 `MutatorRef` 修改.该模块是 DA 标准的扩展.示例见 [`aptos_token.move`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/aptos_token.move). |
...
| **Royalty**     | 可选 [`Royalty`](https://aptos.dev/reference/move/?branch=mainnet\&page=aptos-token-objects/doc/royalty.md#0x4_royalty_Royalty) 结构体,表示销售价格中归创作者的分成比例.可通过 [Royalty 模块](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/royalty.move) 生成的 `MutatorRef` 修改(该模块为 DA 标准扩展,示例见 [`aptos_token.move`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/aptos_token.move)).通常 royalty 设置在 collection 上,但也可为单独的 `Token` 设置自定义分成比例. |
| **URI length**  | 可选字符串,少于 512 字符,链接到 `Collection` 相关内容(可通过 `MutatorRef` 修改).                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
<Aside type="caution">
  修改 royalty 需通过 [Royalty 模块](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/royalty.move) 生成 _单独_ 的 `MutatorRef`.
</Aside>
...
如果你不想自定义 NFT 逻辑,可直接使用 [`aptos_token`](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/aptos_token.move) 模块铸造 NFT.该模块已部署在 `0x4`,支持:
...
- [数字资产示例](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/token_objects)
- [数字资产市场示例](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/marketplace)
- [源代码](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/token.move)
- [`aptos_token` 源代码](https://github.com/libra2org/libra2-core/blob/main/aptos-move/framework/aptos-token-objects/sources/aptos_token.move)
