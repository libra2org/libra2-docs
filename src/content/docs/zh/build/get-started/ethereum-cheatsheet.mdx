---
title: "Ethereum 到 Libra 速查表"
---

如需了解更多差异与相似之处,请参阅 [Libra Learn](https://learn.libra2labs.com/en/tutorials/ethereum-to-libra2-guide/cheat-sheet?workshop=eth-to-libra2)
...
| **区块链交互**  | [Ethers.js library](https://docs.ethers.org/v6/)                                                                               | [Libra Typescript SDK](/zh/build/sdks/ts-sdk)                                                                                         |
...
| **转账机制** | 可在未获接收方明确授权的情况下转账.      | 除特定情况(如 LibraCoin)外,代币通常需要接收方 `signer` 权限进行转账. |
