...
然后,你可以将这个配置文件应用到未来所有你想使用的命令中.比如,如果你想在本地网络上发布一个 Move 模块,譬如 [`hello_blockchain`](https://github.com/libra2org/libra2-core/tree/main/aptos-move/move-examples/hello_blockchain)) 包,你可以执行:
