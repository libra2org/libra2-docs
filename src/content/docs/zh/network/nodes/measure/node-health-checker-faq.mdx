...
Libra2 节点健康检查器(NHC)服务可以用来检查您的节点的健康状态.查看[节点健康检查器](/zh/network/nodes/measure/node-health-checker)获取 NHC 的完整文档.

本常见问题解答的目的是帮助您理解当您为节点运行 NHC 时,为什么节点没有通过某个特定的健康检查.如果您在这个 FAQ 中没有找到您想要的信息,请[提交到 Issue](https://github.com/libra2org/libra2-core/issues/new/choose),或者[提交 PR](https://github.com/libra2org/libra2-core/pulls),然后添加您的问题内容.
