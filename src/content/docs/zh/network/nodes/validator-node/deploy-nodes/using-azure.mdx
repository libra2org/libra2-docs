...
4. 修改 `main.tf` 文件以配置 Terraform 并创建 Terraform 模块.请参阅以下示例:
   ...
   - Terraform 变量 [https://github.com/libra2org/libra2-core/blob/main/terraform/aptos-node/azure/variables.tf](https://github.com/libra2org/libra2-core/blob/main/terraform/aptos-node/azure/variables.tf)
   - Helm 值:[https://github.com/libra2org/libra2-core/blob/main/terraform/helm/aptos-node/values.yaml](https://github.com/libra2org/libra2-core/blob/main/terraform/helm/aptos-node/values.yaml).
