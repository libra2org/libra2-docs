...
4. 修改 `main.tf` 文件以配置 Terraform 并创建 Terraform 模块.请参阅以下示例:
   ...
   - Terraform 变量:[https://github.com/libra2org/libra2-core/blob/main/terraform/aptos-node/aws/variables.tf](https://github.com/libra2org/libra2-core/blob/main/terraform/aptos-node/aws/variables.tf)
