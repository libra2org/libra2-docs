...
1. 转到 Libra 治理页面的[提案部分](https://governance.aptosfoundation.org/).
...
1. 从[Libra Explorer 页面](https://explorer.aptoslabs.com/validators/delegation?network=mainnet)获取您的委托池地址.
2. 执行命令 `aptos governance list-proposals --url https://api.mainnet.aptoslabs.com` 查看提案列表.
3. 运行 `aptos init` 设置您的投票者资料.
