...
<Aside type="caution">
  **最小质押要求**<br />
  只有当您的验证节点能够满足网络的最小[质押要求](/zh/network/blockchain/staking.mdx#minimum-and-maximum-stake)时,您才应遵循这些说明.当前所需的最小质押要求为 100 万 APT Token.
</Aside>
...
要初始化质押池,请按照[质押池操作](/zh/network/nodes/validator-node/connect-nodes/staking-pool-operations.mdx#initialize-a-staking-pool)中的说明进行.如果是要初始化委托池,请按照[委托池操作](/zh/network/nodes/validator-node/connect-nodes/delegation-pool-operations.mdx#initialize-a-delegation-pool)中的说明进行.
