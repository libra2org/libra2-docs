...
3. 下载新的 [genesis.blob](/zh/network/nodes/configure/node-files-all-networks/node-files-mainnet.mdx#genesisblob) 文件和新的 [waypoint](/zh/network/nodes/configure/node-files-all-networks/node-files-mainnet.mdx#waypointtxt).
