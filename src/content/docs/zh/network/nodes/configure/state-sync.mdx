...
<Aside type="note">
  ...
  - **开发网**:要同步整个区块链历史,请使用[智能同步](/zh/network/nodes/configure/state-sync.mdx#智能同步).否则,使用[快速同步](/zh/network/nodes/configure/state-sync.mdx#快速同步).
  - **测试网**:要同步整个区块链历史,请从[备份](/zh/network/nodes/bootstrap-fullnode/aptos-db-restore)中恢复.否则,下载[快照](/zh/network/nodes/bootstrap-fullnode)或使用[快速同步](/zh/network/nodes/configure/state-sync.mdx#快速同步).
  - **主网**:要同步整个区块链历史,请从[备份](/zh/network/nodes/bootstrap-fullnode/aptos-db-restore)中恢复.否则,使用[快速同步](/zh/network/nodes/configure/state-sync.mdx#快速同步).
</Aside>
...
2. 禁用账本裁剪器,如 [数据裁剪文档](/zh/network/nodes/configure/data-pruning.mdx#disable-the-ledger-pruner)中所述.这将确保不删除任何数据,并且 PFN 包含所有区块链数据.
